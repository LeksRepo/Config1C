...
Процедура НайтиПрепятствующиеУдалению(Ссылка, Информация, Результат)
	...
	ПоискНеПрепятствующих = Новый Структура(Результат.ПрепятствующиеУдалению.Колонки[1].Имя, Ссылка);
	НеПрепятствующие = Результат.ПрепятствующиеУдалению.НайтиСтроки(ПоискНеПрепятствующих);
	Для Каждого СтрокаТаблицы Из НеПрепятствующие Цикл
		Результат.ПрепятствующиеУдалению.Удалить(СтрокаТаблицы);
	КонецЦикла;
