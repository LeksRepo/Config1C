...
Процедура ЗагрузитьТаблицаДеталей(АдресТаблицы)
	...
	|	ТаблицаСпецификации.НомерСтроки КАК НомерСтрокиСпецификации,
	...
	|	ВТ_ТаблицаПроверки.НомерСтроки,
	|	ВТ_ТаблицаСпецификации.НоменклатураСпецификации КАК НоменклатураСпецификации1
	|ИЗ
...
Процедура ТаблицаДеталейВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	//	
	//ИначеЕсли Поле.Родитель = Элементы.ТаблицаДеталейГруппаСпецификации Тогда
	//	
	//	
	//	
	//КонецЕсли;
