...
Процедура ВыполнитьАвтоматическоеСопоставлениеДанных(Параметры, АдресВременногоХранилища) Экспорт
	...
	УдалитьКлассификаторыИзСтатистики(ПомощникИнтерактивногоОбменаДанными.ИнформацияСтатистики);
...
Процедура УдалитьКлассификаторыИзСтатистики(Знач ТаблицаИнформацииСтатистики)
	...
	Пока ОбратныйИндекс >= 0 Цикл
		...
		Если Статистика.ЭтоКлассификатор Тогда
