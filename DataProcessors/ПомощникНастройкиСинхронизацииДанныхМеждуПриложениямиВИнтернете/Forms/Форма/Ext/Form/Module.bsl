...
Процедура СценарийНастройкиСинхронизацииДанных()
	...
	ТаблицаПереходовНоваяСтрока(8, "ОжиданиеАнализаДанных",       "СтраницаНавигацииОжидание",,,,, Истина, "ОжиданиеПолученияСтатистикиСопоставления_ОбработкаДлительнойОперации").Метка = "СтраницаСтатистики";
