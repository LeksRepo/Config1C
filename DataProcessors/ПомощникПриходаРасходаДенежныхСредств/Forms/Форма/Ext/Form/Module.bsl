...
Процедура Далее(Команда)
	...
	ИначеЕсли ТекущаяОсновнаяСтраница = ПодчиненныеСтраницы.ЭтапВыбораКонтрагентаДоговора Тогда
		...
		Если Печать Тогда
			...
			КонецЕсли;
			//	УправлениеПечатьюКлиент.ВыполнитьКомандуПечати("Документ.РасходДенежныхСредств", "РасходныйКассовыйОрдер", Массив, Неопределено, Неопределено);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Договор") Тогда // ДокументОснование надо
		
		ДокументОснование = Параметры.Договор;
	...
	ИначеЕсли Параметры.Свойство("ДополнительноеСоглашение") Тогда
		...
		ДокументОснование = Параметры.ДополнительноеСоглашение;
	...
	ИначеЕсли Параметры.Свойство("Спецификация") Тогда
		...
		ДокументОснование = Параметры.Спецификация;
		Контрагент = ДокументОснование.Контрагент;
		Подразделение = ДокументОснование.Подразделение;
		ВидПлатежа = "Приход";
		СпособПлатежа = "Нал";
