...
Процедура СформироватьПриход(НовыйДокумент)
	...
	ИначеЕсли СпособПлатежа = "Безнал" Тогда
		...
		НовыйДокумент.Субконто1Дт = ?(ПлатежОтДилера, Справочники.СтатьиДвиженияДенежныхСредств.ПоступленияОтДилеровПоСпецификациям, Справочники.СтатьиДвиженияДенежныхСредств.ПоступленияПоДоговорам);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Сотрудник = ЛексСервер.ПолучитьЗначениеНастройкиПользователя(Пользователь, ПланыВидовХарактеристик.НастройкиПользователей.ФизЛицо);
