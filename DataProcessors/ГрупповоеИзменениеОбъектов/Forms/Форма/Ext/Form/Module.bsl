...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.ГрупповоеИзменениеОбъектов.Форма.ДополнительныеПараметры") Тогда
...
Процедура ПерейтиВЖурналРегистрации(Команда)
	Если ПодсистемаСуществует("СтандартныеПодсистемы.БазоваяФункциональность") Тогда
		НастройкаОтбора = Новый Структура("Пользователь", ТекущийПользователь());
		МодульЖурналРегистрацииКлиент = ОбщийМодуль("ЖурналРегистрацииКлиент");
		МодульЖурналРегистрацииКлиент.ОткрытьЖурналРегистрации(НастройкаОтбора, ЭтаФорма);
	КонецЕсли;
КонецПроцедуры
