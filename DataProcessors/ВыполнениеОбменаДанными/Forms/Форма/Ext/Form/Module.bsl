...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если МодульАвтономнаяРаботаСлужебный = Неопределено Тогда
...
Функция СохранитьФлагВопросаОДолгойСинхронизацииСервер(Знач Флаг, Настройки = Неопределено)
	...
	НадоСохранять = МодульАвтономнаяРаботаСлужебный <> Неопределено 
		И МодульАвтономнаяРаботаСлужебный.ЭтоАвтономноеРабочееМесто() 
