...
//                                 опредения и редактирования частей формы.
//
...
Процедура КомандаОК(Команда)
	...
	Если Модифицированность Тогда
		Результат = Новый Структура("Код, Представление, НаселенныйПунктДетально", 
			...
			КонтактнаяИнформацияКлиент.НаименованиеНаселенногоПунктаПоЧастямАдреса(ЧастиАдреса), 
			ЧастиАдреса
		);
...
Функция УстановитьЗначениеЧастиАдреса(Элемент, ВыбранноеЗначение)
	...
	// Ставим в форму, автогенерированые имена элементов и реквизитов совпадают
