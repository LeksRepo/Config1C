...
Процедура ОткрытьСпецификацию()
	...
	Иначе
		...
		//ПараметрыФормы.Вставить("Контрагент", СтруктураРеквизитов.Контрагент);
		//ПараметрыФормы.Вставить("АдресМонтажа", СтруктураРеквизитов.АдресМонтажа);
		//ПараметрыФормы.Вставить("Телефон", СтруктураРеквизитов.Телефон);
...
Процедура Далее(Команда)
	...
	ИначеЕсли ТекущаяОсновнаяСтраница = ПодчиненныеСтраницы.ЭтапПроверкиСпецификации Тогда
		...
		Иначе
			...
			ЭтаФорма.Закрыть();
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = "Вы не сохранили документ спецификация. Доп. соглашение не было создано.";
			Сообщение.Сообщить();
