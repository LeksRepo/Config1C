...
Процедура Далее(Команда)
	...
	Если ТекущаяОсновнаяСтраница = ПодчиненныеСтраницы.ПервыйЭтап Тогда
		...
		Если ЗначениеЗаполнено(Спецификация) Тогда
			...
			Элементы.Декорация15.Заголовок = "1. Будет открыт существующий документ ""Спецификация"". Нажмите ""Далее>>"".";
			
		Иначе
			
			Элементы.Декорация15.Заголовок = "1. Старый документ ""спецификация"" не доступен для редактирования. Будет создан новый. Нажмите ""Далее >>"".";
