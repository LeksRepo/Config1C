...
Функция ПроверитьСтатусСпецификации(Договор)
	...
	СтатусыСпецификации = Перечисления.СтатусыСпецификации;
	РазрешеноИзменятьСпецификацию= (Статус = СтатусыСпецификации.Сохранен
		или Статус = СтатусыСпецификации.ПроверенЛогистом или Статус = СтатусыСпецификации.ПроверенТехнологом 
		или Статус = СтатусыСпецификации.ПроверяетсяЛогистом или Статус = СтатусыСпецификации.ПроверяетсяТехнологом);
...
Процедура ПоменятьСтатусСпецификации(Спецификация)
	...
	Документы.Спецификация.УстановитьСтатусСпецификации(Спецификация, Перечисления.СтатусыСпецификации.ПроверяетсяТехнологом);
