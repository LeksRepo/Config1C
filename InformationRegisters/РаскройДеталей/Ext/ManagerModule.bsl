	...
	Для Каждого ЭлементСписка Из СписокНоменклатуры Цикл // цикл по материалам
		...
		Если НЕ ТекущаяНоменклатура.НаличиеТекстуры Тогда
			...
			Если ТипЗнч(СтруктураДляСтрокиРаскроя) = Тип("Структура") Тогда
				...
				Если СтруктураДляСтрокиРаскроя.КоличествоЛистов > СтруктураДляСтрокиРаскрояПовернутыхДеталей.КоличествоЛистов ИЛИ 
					СтруктураДляСтрокиРаскроя.ПлощадьОстатковПоНоменклатуре < СтруктураДляСтрокиРаскрояПовернутыхДеталей.ПлощадьОстатковПоНоменклатуре Тогда
