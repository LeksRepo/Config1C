...
Функция РасположитьНаЛистахМетодомРанца(СсылкаДокумента, СписокДеталей)
	...
	ТаблицаТаблицДляОбрезков = Новый ТаблицаЗначений;
	ТаблицаТаблицДляОбрезков.Колонки.Добавить("Номенклатура", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	ТаблицаТаблицДляОбрезков.Колонки.Добавить("КоличествоЛистов", Новый ОписаниеТипов("Число"));
	ТаблицаТаблицДляОбрезков.Колонки.Добавить("Таблица", Новый ОписаниеТипов("ТаблицаЗначений"));
	...
	Для Каждого ЭлементСписка Из СписокНоменклатуры Цикл // цикл по материалам
		...
		НоваяСтрочка = ТаблицаТаблицДляОбрезков.Добавить();
		НоваяСтрочка.Номенклатура = ТекущаяНоменклатура;
		НоваяСтрочка.Таблица = Таб;
		НоваяСтрочка.КоличествоЛистов = СтруктураДляСтрокиРаскроя.КоличествоЛистов;
	...
	СтруктураРезультатов.Вставить("ТаблицаТаблицДляОбрезков", Новый ХранилищеЗначения(ТаблицаТаблицДляОбрезков));
