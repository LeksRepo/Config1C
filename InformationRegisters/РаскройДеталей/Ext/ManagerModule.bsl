	...
	Иначе
		...
		Иначе
			...
			Если НЕ КоличествоВПогонныхМетрах Тогда
				 ...
				 ПлощадьПила = ПростоПлощадьВсехЛистов - (ПлощадьДеталей + СтруктураОптимальногоОстатка.ПлощадьОбрезковПоНоменклатуре + СтруктураОптимальногоОстатка.ПлощадьОстатковПоНоменклатуре);   
				 ПлощадьОбрезковПоНоменклатуре = ПлощадьОбрезковПоНоменклатуре + ПлощадьПила;
