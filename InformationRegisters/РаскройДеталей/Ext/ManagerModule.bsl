...
Функция ФормированиеПакета(Знач СписокДеталейНоменклатуры, Знач ВысотаЛиста, Знач ШиринаЛиста, ТолщинаПила, Номенклатура)
		...
		Для каждого Столбец Из Строка.Пакет Цикл
			...
			Для Каждого Деталь Из РазмещаемыйПакет Цикл
				...
				Иначе
					...
					//Элемент.НомерПакета = Пакет.НомерПакета;
					//
					//КоординатаУ = КоординатаУ + Элемент.ВысотаДетали + ТолщинаПила;
					//
					//ПоследняяДетальПакета = Элемент;
					//
					//СписокДеталейНоменклатуры.Найти(Элемент.ИД, "ИД").ДетальВПакете = Истина;
					//СписокДеталейНоменклатуры.Найти(Элемент.ИД, "ИД").НомерПакета = Пакет.НомерПакета;
