		...
		Для Инд = 0 По ОбходовПоТекстуре Цикл
			...
			Для Каждого ОстатокЛинии Из МассивОстатковЛиний Цикл
				...
				Если (КоличествоЛистов = 0) ИЛИ (КоличествоЛистов >= КоличествоЛистовАлгоритма) Тогда
					СтруктураОптимальногоОстатка = ОптимизацияОстатков(ДопустимыйОстатокПоШирине, ДопустимыйОстатокПоВысоте, СписокДеталейНоменклатуры, НомерЛиста, КонечныйНомерЛиста, ТолщинаПила, ПределыОстатков);
...
Функция ОптимизацияОстатков(ДопустимыйОстатокПоШирине, ДопустимыйОстатокПоВысоте, СписокДеталейНоменклатуры, НомерЛиста, КонечныйНомерЛиста, ТолщинаПила, ПределыОстатков)
	...
	Для ТекущийНомерЛиста = КонечныйНомерЛиста + 1 По НомерЛиста Цикл
		...
		//_____2_____
		Если МассивОстатков[0].ВысотаДетали > ДопустимыйОстатокПоВысоте И МассивОстатков.Количество() > 1 Тогда //высота макс. горизонт. линии пила больше допустимого
