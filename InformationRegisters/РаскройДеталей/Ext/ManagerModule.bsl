...
Процедура ФормированиеПакетаУзкоДлинные(Знач СписокДеталейНоменклатуры, Знач ОсобыйПорядок, Знач ВысотаЛиста, Знач ШиринаЛиста, ТолщинаПила, Номенклатура, ЭтоМДФ)
