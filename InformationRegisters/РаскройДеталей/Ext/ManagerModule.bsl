...
Функция ФормированиеСтрокиРаскроя(СтрокаРаскроя, ТаблицаДеталей, ТаблицаКромок)
	...
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("ТаблицаКромок", ТаблицаКромок);
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ТаблицаКромок.НоменклатураКромки,
	|	ТаблицаКромок.ГруппаКромок,
	|	ТаблицаКромок.НомерЛиста,
	|	ТаблицаКромок.Количество
	|ПОМЕСТИТЬ ТаблицаКромок
	|ИЗ
	|	&ТаблицаКромок КАК ТаблицаКромок";
