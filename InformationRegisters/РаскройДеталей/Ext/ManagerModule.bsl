...
Функция РасположитьНаЛистах(СсылкаДокумента, СписокДеталей)
	...
	Для Каждого ЭлементСписка Из СписокНоменклатуры Цикл // цикл по материалам
		...
		Структура = СтарыйАлгоритм(ЭлементСписка, ТолщинаПила, ПределыОстатков, КонечныйНомерЛиста, КоличествоЛистов, МассивОстатковЛиний, СписокДеталей, СтруктураРезультатов, ТаблицаЛистовНоменклатуры, МассивИтоговогоРасположенияДеталей);
...
Функция СтарыйАлгоритм(ЭлементСписка, ТолщинаПила, ПределыОстатков, КонечныйНомерЛиста, КоличествоЛистов, МассивОстатковЛиний, СписокДеталей, СтруктураРезультатов, ТаблицаЛистовНоменклатуры, МассивИтоговогоРасположенияДеталей)
	...
	ТекущаяНоменклатура = ЭлементСписка.Номенклатура;
		...
		СтруктураИтогАлгоритма.Вставить("", );
		СтруктураИтогАлгоритма.Вставить("", );
		СтруктураИтогАлгоритма.Вставить("", );
		СтруктураИтогАлгоритма.Вставить("", );
		СтруктураИтогАлгоритма.Вставить("", );
