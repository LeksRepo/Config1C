...
Процедура КопироватьДанные(Команда)
	...
	Если ЗначениеЗаполнено(НоменклатурнаяГруппа) И ЗначениеЗаполнено(Подразделение) Тогда
		...
		ОткрытьФорму("РегистрСведений.СеткаОстатков.Форма.ФормаКопирования");
		
	Иначе
		
		Сообщить("Выберите подразделение и номенклатурную группу");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИсточникПодразделение = Параметр.ИсточникПодразделение;
	ИсточникНоменклатурнаяГруппа = Параметр.ИсточникНомГруппа;
...
&НаКлиенте
Процедура ОткрытьФормуУдаления(Команда)
	
	ОткрытьФорму("РегистрСведений.СеткаОстатков.Форма.ФормаУдаления");
