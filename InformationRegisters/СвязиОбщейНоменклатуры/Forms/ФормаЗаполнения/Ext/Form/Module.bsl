...
Процедура ЗаписатьНаСервере()
	...
	Для Каждого Строка Из Список Цикл
		...
		Если ЗначениеЗаполнено(Строка.ОбщаяНоменклатура) И ЗначениеЗаполнено(Строка.Номенклатура) Тогда
			...
			НоваяЗапись.Номенклатура2 = Строка.Номенклатура2;
			НоваяЗапись.Номенклатура3 = Строка.Номенклатура3;
			НоваяЗапись.Номенклатура4 = Строка.Номенклатура4;	
...
Процедура ЗаполнитьТекущимиНаСервере()
	...
	|	СвязиОбщейНоменклатуры.Номенклатура2,
	|	СвязиОбщейНоменклатуры.Номенклатура3,
	|	СвязиОбщейНоменклатуры.Номенклатура4
	|ИЗ
	...
	Если НЕ Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			  ...
			  Строка.Номенклатура2 = Выборка.Номенклатура2;
			  Строка.Номенклатура3 = Выборка.Номенклатура3;
			  Строка.Номенклатура4 = Выборка.Номенклатура4;
