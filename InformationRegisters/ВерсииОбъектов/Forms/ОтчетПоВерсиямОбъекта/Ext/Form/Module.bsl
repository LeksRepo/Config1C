	...
	Если ВерсияОбъекта.ТабличныеЧасти.Количество() <> 0 Тогда
		...
		Для Каждого СтрокаТабличнаяЧасть Из ВерсияОбъекта.ТабличныеЧасти Цикл
			...
			Если ТабличнаяЧасть.Количество() > 0 Тогда
				...
				ТЧОтчета.Область("R"+Строка(Формат(ОбластьВывода.Верх, "ЧГ=0"))+"C2").СоздатьФорматСтрок();
				ТЧОтчета.Область("R"+Строка(Формат(ОбластьВывода.Верх, "ЧГ=0"))+"C2").ШиринаКолонки = Окр(СтрДлина(СинонимТЧ)*2, 0, РежимОкругления.Окр15как20);
				...
				Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
					...
					УстановитьСвойстваТекста(Секция.Область("R" + Строка(Формат(НомерСтроки, "ЧГ=0")) + "C1"), Строка(НомерСтроки-1), , , , , Истина);
				КонецЦикла;
				...
				Для Каждого КолонкаТабличнойЧасти Из ТабличнаяЧасть.Колонки Цикл
					...
					Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
						...
						УстановитьСвойстваТекста(Секция.Область("R" + Строка(Формат(НомерСтроки, "ЧГ=0")) + "C1"), ПредставлениеЗначения, , , , , Истина);
				...
				ТЧОтчета.Область("R"+Строка(Формат(ОбластьВывода.Верх, "ЧГ=0"))+"C1:R"+Строка(Формат(ОбластьВывода.Низ, "ЧГ=0"))+"C"+НомерКолонки).СоздатьФорматСтрок();
				ТЧОтчета.Область("R"+Строка(Формат(ОбластьВывода.Верх, "ЧГ=0"))+"C2").ШиринаКолонки = 7;
				Для ТекущийНомерКолонки = 3 По НомерКолонки-1 Цикл
					ТЧОтчета.Область("R"+Строка(Формат(ОбластьВывода.Верх, "ЧГ=0"))+"C"+ТекущийНомерКолонки).ШиринаКолонки = СоответствиеРазмерностиКолонок[ТекущийНомерКолонки];
				КонецЦикла;
				ТЧОтчета.ЗакончитьГруппуСтрок();
