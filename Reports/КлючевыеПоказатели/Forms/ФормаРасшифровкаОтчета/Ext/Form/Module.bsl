...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.УстановитьПараметр("СписокПодразделений", Параметры.СписокПодразделений);
	Запрос.УстановитьПараметр("Раздел", Параметры.Раздел);
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	ОбластьЗаголовок.Параметры.Раздел = Параметры.Раздел;
	ОбластьЗаголовок.Параметры.Период = Параметры.Период;
	ОбластьЗаголовок.Параметры.СписокПодразделений = Параметры.СписокПодразделений;
	...
	Пока ВыборкаВидСтатьи.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			ОбластьСтрока.Параметры.Расшифровка = Новый Структура("Статья,Период,СписокПодразделений", Выборка.Статья, Параметры.Период, Параметры.СписокПодразделений);
