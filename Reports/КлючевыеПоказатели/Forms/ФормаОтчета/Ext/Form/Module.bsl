...
&НаСервере
функция ПолучитьОтклонениеПоКассе(НачалоПериода, КонецПериода, СписокПодразделений)
...
Функция ЗаполнитьПоказатели(НачалоПериода, КонецПериода, СписокПодразделений)
	...
	ОтклонениеПоКассеЗаПериод = ПолучитьОтклонениеПоКассе(НачалоПериода, КонецПериода, СписокПодразделений);
	...
	ДобавитьПоказатель("Отклонение за период", ОтклонениеПоКассеЗаПериод);
