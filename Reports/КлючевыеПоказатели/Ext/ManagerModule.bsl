...
Функция ЗаполнитьТаблицу(НачалоПериода, КонецПериода, СписокПодразделений, ВидОтчета, ТЗСтатьи)
	...
	МассивПоказателей.Добавить(Перечисления.ВидыПоказателейСотрудников.СтоимостьРеализованныхМатериалов);
	МассивПоказателей.Добавить(Перечисления.ВидыПоказателейСотрудников.СтоимостьРазмещенныхСпецификацийДилеров);
	МассивПоказателей.Добавить(Перечисления.ВидыПоказателейСотрудников.СтоимостьРазмещенныхСпецификаций);
	МассивПоказателей.Добавить(Перечисления.ВидыПоказателейСотрудников.СтоимостьЗаключенныхДоговоров);
	МассивПоказателей.Добавить(Перечисления.ВидыПоказателейСотрудников.СтоимостьПродажСерийнойМебели);
