...
Функция СформироватьРасшифровку(ИмяПоля, Номенклатура, Период, Регион)
	...
	|	УправленческийОбороты.КоличествоОборотДт * ЦеныНоменклатурыСрезПоследних.Внутренняя КАК Стоимость
	|ИЗ
...
&НаКлиенте
Процедура ВПлановыхЦенахПриИзменении(Элемент)
	
	Если ВПлановыхЦенах Тогда
		
		ЭтаФорма.УстановитьТекущийВариант("ВПлановыхЦенах");
