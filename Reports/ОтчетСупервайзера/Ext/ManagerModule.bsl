...
Функция СформироватьОтчет(ПараметрыОтчета) Экспорт
	...
	|	И (ФизическиеЛица.Должность = ЗНАЧЕНИЕ(Справочник.Должности.ВедущийДизайнер)
	|		ИЛИ ФизическиеЛица.Должность = ЗНАЧЕНИЕ(Справочник.Должности.ДизайнерКонсультант)
	|		ИЛИ ФизическиеЛица.Должность = ЗНАЧЕНИЕ(Справочник.Должности.СупервайзерРозничныхПродаж))
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
