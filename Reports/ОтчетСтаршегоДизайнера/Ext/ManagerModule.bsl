		...
		Пока ВыборкаПоСотрудникам.Следующий() Цикл
			...
			Если ЭтоЗамеры Тогда
				...
				Если ЗначениеЗаполнено(ВыборкаПоСотрудникам.ДатаВстречи)  
					И НачалоДня(ВыборкаПоСотрудникам.ДатаВстречи) < НачалоДня(ТекущаяДата()) 
					И НачалоДня(ВыборкаПоСотрудникам.ДатаВстречи) >= НачалоДня(ДобавитьМесяц(ТекущаяДата(), -1)) Тогда
					
					ОбластьСтрокаЗамеры.Области.ОбластьДатаВстречи.ЦветТекста = Новый Цвет(252,0,0);
					ОбластьСтрокаЗамеры.Области.ОбластьДатаВстречи.Шрифт = Новый Шрифт(,9,Истина);
