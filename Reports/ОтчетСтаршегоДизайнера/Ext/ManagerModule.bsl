...
Функция ПолучитьЗапрос(ПараметрыОтчета)
	...
	|	4,
	|	ВЫБОР
	|		КОГДА ДокДоговор.Спецификация.Дилерский
	|			ТОГДА ДокДоговор.Спецификация.Контрагент.Супервайзер
	|		КОГДА ДокДоговор.Спецификация.Изделие.ЭтоДетали
	|			ТОГДА ДокДоговор.Спецификация.Автор.ФизическоеЛицо
	|		ИНАЧЕ ДокДоговор.Спецификация.Офис.СтаршийОфиса
	|	КОНЕЦ
	|ИЗ
