	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаПоСотрудникам.Следующий() Цикл
			...
			ИначеЕсли ЭтоАкт И ОтчетСтДиз Тогда
				...
				ОбластьСтрокаАкт.Параметры.Предмет = "№ "+ПрефиксацияОбъектовКлиентСервер.УдалитьЛидирующиеНулиИзНомераОбъекта(ВыборкаПоСотрудникам.Предмет.Номер)+" от "+Формат(ВыборкаПоСотрудникам.Предмет.Дата,"ДФ=dd.MM.yy");
