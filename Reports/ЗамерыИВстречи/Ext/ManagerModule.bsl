...
Функция СформироватьОтчет(ПараметрыОтчета) Экспорт
	...
	//|						ТОГДА ФизЛицо = &Ответственный
	//|					ИНАЧЕ ИСТИНА
	//|				КОНЕЦ) КАК ДолжностиСотрудниковСрезПоследних
	//|ГДЕ
	//|	ДолжностиСотрудниковСрезПоследних.Работает
	//|	И ДолжностиСотрудниковСрезПоследних.Должность.ЗамерыИВстречи";
	...
	|	И ФизическиеЛица.Ссылка = &Ответственный
	|   И ФизическиеЛица.Работает
	|   И ФизическиеЛица.Должность.ЗамерыИВстречи
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	Монтаж.ДатаМонтажа МЕЖДУ &ДатаНачала И &ДатаОкончания
	|	И Монтаж.Спецификация.ДокументОснование.Подразделение = &Подразделение
