...
Процедура ТабДокОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ТипЗнч(Расшифровка) = Тип("Структура") Тогда	
		...
		Иначе                         
			...
			СписокКнопок.Добавить(КодВозвратаДиалога.Да, "Замер");
			СписокКнопок.Добавить(КодВозвратаДиалога.Нет, "Встреча");
						
			Ответ = Вопрос(,СписокКнопок);
			
			Если Ответ = КодВозвратаДиалога.Да Тогда	
				
				ПараметрыФормы = Новый Структура("Время, Подразделение, Замерщик", Расшифровка.Время, Расшифровка.Подразделение, Расшифровка.Ответственный);
