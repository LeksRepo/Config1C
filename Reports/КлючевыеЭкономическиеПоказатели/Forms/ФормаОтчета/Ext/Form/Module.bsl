...
Процедура СформироватьНаСервере()
	...
	ОстатокВКассах = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.Касса, ВидДвиженияБухгалтерии.Дебет);
	ОстатокВОперационныхКассах = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.ОперационнаяКасса, ВидДвиженияБухгалтерии.Дебет);
	ОстатокВПодотчете = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.Подотчет, ВидДвиженияБухгалтерии.Дебет);
	ОстатокНаРасчетныхСчетах = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.РасчетныйСчет, ВидДвиженияБухгалтерии.Дебет);
	...
	МыДолжныИтого = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.Взаиморасчеты, ВидДвиженияБухгалтерии.Кредит);
	НамДолжныИтого = ПолучитьОстатокПоСчету(ПланыСчетов.Управленческий.Взаиморасчеты, ВидДвиженияБухгалтерии.Дебет);
