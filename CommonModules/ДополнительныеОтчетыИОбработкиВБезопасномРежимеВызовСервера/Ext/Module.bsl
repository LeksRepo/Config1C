...
//
Функция ВыполнитьСценарийВБезопасномРежиме(Знач КлючСессии, Знач АдресСценария, ПараметрыВыполнения = Неопределено, Знач СохраняемыеПараметры = Неопределено, ОбъектыНазначения = Неопределено) Экспорт
