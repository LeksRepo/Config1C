...
Функция ОбработчикиИнициализацииПараметровСеанса() Экспорт
	...
	Обработчики.Вставить("ТекущийКонтрагент", "ЛексСервер.УстановкаПараметраСеансаТекущийКонтрагент");
	Обработчики.Вставить("ТекущееПодразделение", "ЛексСервер.УстановкаПараметраСеансаТекущееПодразделение");
