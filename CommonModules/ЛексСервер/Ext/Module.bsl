...
Функция ПеремещениеМатериаловСЛогистики(Ссылка, Движения) Экспорт
	...
	Иначе
		...
		ПодразделениеПроизводство = Ссылка.Производство;
...
Функция ПечататьТорг12(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Спецификация Тогда
			...
			ПредставлениеГрузоотпрвителя = СтруктураРеквизитовВяса.ПолноеНаименование + ", ИНН " + СтруктураРеквизитовВяса.ИНН + ", " + Выборка.ФактическийАдрес + ", р/с " + СтруктураРеквизитовВяса.РасчетныйСчет + ", БИК " + СтруктураРеквизитовВяса.БИК + ", корр/с " + СтруктураРеквизитовВяса.КорреспондирующийСчет;
			ПредставлениеОрганизации = СтруктураРеквизитовВяса.ПолноеНаименование + ", ИНН " + СтруктураРеквизитовВяса.ИНН + ", " + Выборка.ПодразделениеЮридическийАдресОрганизации + ", р/с " + СтруктураРеквизитовВяса.РасчетныйСчет + ", БИК " + СтруктураРеквизитовВяса.БИК + ", корр/с " + СтруктураРеквизитовВяса.КорреспондирующийСчет;
