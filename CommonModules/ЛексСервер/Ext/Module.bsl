...
Процедура Перепроведение() Экспорт
	...
	//|	ДатыЗапретаИзменения.Раздел.Наименование КАК Раздел,
	//|	ДатыЗапретаИзменения.Объект.Наименование КАК Объект
	//|ИЗ
	//|	РегистрСведений.ДатыЗапретаИзменения КАК ДатыЗапретаИзменения
	//|ГДЕ
	//|	(ДатыЗапретаИзменения.Пользователь = ЗНАЧЕНИЕ(Перечисление.ВидыНазначенияДатЗапрета.ДляВсехПользователей)
	//|			ИЛИ ДатыЗапретаИзменения.Пользователь = &ТекущийПользователь)
	//|
	//|СГРУППИРОВАТЬ ПО
	//|	ДатыЗапретаИзменения.Раздел.Наименование,
	//|	ДатыЗапретаИзменения.Объект.Наименование";
	//
	...
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		...
		Путь = "E:\Profiles\USR1CV82\errors\Ошибки перепроведения за " + Формат(ТекущаяДата(), "ДФ=dd-MM-yyyy") + ".txt";
