...
Процедура УстановитьДатуИзготовленияСпецификации(Спецификация) Экспорт
	...
	Если ЗначениеЗаполнено(Спецификация.ДатаОтгрузки) Тогда
		...
		ЕстьУслуги = Число(Спецификация.ЭтоКухня ИЛИ ЕстьФотопечать ИЛИ ЕстьУпаковка);
		ДнейНаИзготовление = 2 + ЕстьУслуги;
		...
		Если РабочихДнейДоОтгрузки < (2+ЕстьУслуги) Тогда
