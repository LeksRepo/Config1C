...
Процедура Перепроведение() Экспорт
	...
	Если ЗначениеЗаполнено(ТекстПроведения) Тогда
		...
		Адресаты.Добавить(Справочники.УчетныеЗаписиЭлектроннойПочты.УчетнаяЗаписьГлБухгалтера.АдресЭлектроннойПочты);
		
		ЛайнДВ = Справочники.ФизическиеЛица.НайтиПоКоду("000000172");
		Адресаты.Добавить(ЛайнДВ.ЭлектронныйАдрес);
		
		ЛайнЖЭ = Справочники.ФизическиеЛица.НайтиПоКоду("000000004");
		Адресаты.Добавить(ЛайнЖЭ.ЭлектронныйАдрес);
