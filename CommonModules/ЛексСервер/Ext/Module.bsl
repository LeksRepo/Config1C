...
Функция УстановитьДатуОтгрузкиСпецификации(Спецификация) Экспорт
	
	Если ЗначениеЗаполнено(Спецификация.ДатаМонтажа) Тогда
		
		Если ДеньНедели(Спецификация.ДатаМонтажа) > 1 Тогда
			МинусДней = 1;
		Иначе
			МинусДней = 2;
		КонецЕсли;
		
		Спецификация.ДатаОтгрузки = Спецификация.ДатаМонтажа - МинусДней * 86400;
