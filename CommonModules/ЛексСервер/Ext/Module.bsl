...
Процедура ДобавитьПоказательСотрудника(Подразделение, ФизическоеЛицо, Движения, Дата, Сумма, Количество, Соглашение)
	...
	Проводки.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.ВидыПоказателей] 	= Перечисления.ВидыПоказателейСотрудников.ЗаключенныеДоговоры;
	...
	Если НЕ Соглашение Тогда
		...
		Проводки.КоличествоДт 	= Количество;
