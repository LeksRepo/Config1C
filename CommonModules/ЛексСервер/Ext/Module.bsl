...
Функция ЗакрытьДопСоглашенияДоговора(Движения, ДоговорСсылка) Экспорт
	...
	|	ДополнительноеСоглашение.Договор КАК Договор,
	|	АктВыполненияДоговора.Дата КАК Дата
	|ИЗ
	|	Документ.ДополнительноеСоглашение КАК ДополнительноеСоглашение
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.АктВыполненияДоговора КАК АктВыполненияДоговора
	|		ПО ДополнительноеСоглашение.Договор = АктВыполненияДоговора.Договор
	|ГДЕ
