...
Функция ПечататьТорг12(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Спецификация Тогда
			...
			ПредставлениеОрганизации = СтруктураРеквизитовВяса.ПолноеНаименование + ", ИНН " + СтруктураРеквизитовВяса.ИНН + ", " + Выборка.ФактическийАдрес + ", р/с " + СтруктураРеквизитовВяса.РасчетныйСчет + ", БИК " + СтруктураРеквизитовВяса.БИК + ", корр/с " + СтруктураРеквизитовВяса.КорреспондирующийСчет;
