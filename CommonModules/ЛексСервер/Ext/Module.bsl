	...
	Пока Выборка.Следующий() Цикл
		...
		Для Сч = 1 По КоличествоЭкземпляров Цикл 
			...
			Если Спецификация Тогда
				...
				ОбластьСтрока.Параметры.Цена = Выборка.СуммаДокумента; 
				ОбластьСтрока.Параметры.СуммаБезНДС = Выборка.СуммаДокумента;
				ОбластьСтрока.Параметры.СуммаСНДС = Выборка.СуммаДокумента;
