...
Функция ПеремещениеМатериаловСЛогистики(Ссылка, Движения) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Ссылка.Дата > '2013.12.18' И Выборка.КоличествоОстаток < Выборка.Количество Тогда
...
Функция ПолучитьСкидкуДоговора(Подразделение, Период, Сумма, ВидОплаты) Экспорт
