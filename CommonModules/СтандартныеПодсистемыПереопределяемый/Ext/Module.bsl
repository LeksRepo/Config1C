...
Функция ОбработчикиОбновленияСтандартныхПодсистем() Экспорт
	...
	Анкетирование.ЗарегистрироватьОбработчикиОбновления(Обработчики);
...
Функция ДобавитьПараметрыРаботыКлиентскойЛогикиСтандартныхПодсистемПриЗапуске(Параметры) Экспорт
	...
	ИнформацияПриЗапуске.ДобавитьПараметрыРаботыКлиента(Параметры);
...
// Обработчик события "При обновлении параметров работы программы".
// Выполняет загрузку параметров работы программы, полученных из главного узла РИБ.
//
Процедура ПриОбновленииПараметровРаботыПрограммы(Отказ) Экспорт
	
	// СтандартныеПодсистемы.ОбменДанными
	ОбменДаннымиСервер.ПриОбновленииПараметровРаботыПрограммы(Отказ);
	// Конец СтандартныеПодсистемы.ОбменДанными
	
КонецПроцедуры

// Устанавливает признак необходимости загрузки параметров работы программы из сообщения обмена.
// Очищает хранилище сообщения обмена, полученного из главного узла РИБ.
//
Процедура ПриОшибкеПолученияПараметровРаботыПрограммы() Экспорт
	
	// СтандартныеПодсистемы.ОбменДанными
	ОбменДаннымиСервер.ПриОшибкеПолученияПараметровРаботыПрограммы();
	// Конец СтандартныеПодсистемы.ОбменДанными
...
Функция НастройкаПодчиненногоУзлаРИБ() Экспорт
	...
	// СтандартныеПодсистемы.ОбменДанными
	Возврат ОбменДаннымиСервер.НастройкаПодчиненногоУзлаРИБ();
	// Конец СтандартныеПодсистемы.ОбменДанными
...
Процедура ПриОтправкеДанныхПодчиненному(Источник = Неопределено, ЭлементДанных, ОтправкаЭлемента, СозданиеНачальногоОбраза) Экспорт
	...
	ПриОтправкеДанных(ЭлементДанных, ОтправкаЭлемента, СозданиеНачальногоОбраза);
...
Процедура ПриПолученииДанныхОтГлавного(Источник = Неопределено, ЭлементДанных, ПолучениеЭлемента, ОтправкаНазад) Экспорт
	...
	// СтандартныеПодсистемы.ОбменДанными
	// Вставка кода от подсистемы обмена данными должна быть первой.
	ОбменДаннымиСобытия.ПриПолученииДанныхОтГлавного(ЭлементДанных, ПолучениеЭлемента, ОтправкаНазад);
	// Конец СтандартныеПодсистемы.ОбменДанными
...
//
Процедура ПриОтправкеДанных(ЭлементДанных, ОтправкаЭлемента, Знач СозданиеНачальногоОбраза)
	
	Если Не СозданиеНачальногоОбраза Тогда
		
		Если ТипЗнч(ЭлементДанных) = Тип("СправочникОбъект.ИдентификаторыОбъектовМетаданных") Тогда
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсияИБ, Знач ТекущаяВерсияИБ, 
	...
	// СтандартныеПодсистемы.ИнформацияПриЗапуске
	ИнформацияПриЗапуске.ПослеОбновленияИнформационнойБазы();
	// Конец СтандартныеПодсистемы.ИнформацияПриЗапуске
	...
	ОбновлениеИнформационнойБазыСлужебныйВМоделиСервиса.ПослеОбновленияИнформационнойБазы();
