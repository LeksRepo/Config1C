...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	ЛексКлиент.ОбщегоНазначенияКлиентПереопределяемыйПередНачаломРаботыСистемы(Параметры);
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	ЛексКлиент.ОбщегоНазначенияКлиентПереопределяемыйПриНачалеРаботыСистемы();
