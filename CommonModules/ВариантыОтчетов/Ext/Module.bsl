...
Функция ИспользуемыеРазделы() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.НастройкиПрограммы") Тогда
		...
		МодульОбработкиПанельАдминистрированияБСП.ПриОпределенииРазделовСВариантамиОтчетов(РазделыМетаданные);
	КонецЕсли;
...
Процедура ПриДобавленииСлужебныхСобытий(КлиентскиеСобытия, СерверныеСобытия) Экспорт
	...
	//	Переименование = Изменения.Добавить();
	//	Переименование.Отчет = Метаданные.Отчеты.<ИмяОтчета>;
	//	Переименование.СтароеИмяВарианта = "<СтароеИмяВарианта>";
	//	Переименование.АктуальноеИмяВарианта = "<АктуальноеИмяВарианта>";
	//КонецПроцедуры
	//
	// Важно:
	...
	//
	// (То же, что ВариантыОтчетовПереопределяемый.ЗарегистрироватьИзмененияКлючейВариантовОтчетов).
...
Процедура ДеревоПодсистемДобавитьУсловноеОформление(Форма) Экспорт
	...
	ДобавитьЭлементУсловногоОформления(Форма, Отборы, Оформление, Поля);
...
Функция ДобавитьЭлементУсловногоОформления(Форма, Отборы, Оформление, Поля)
