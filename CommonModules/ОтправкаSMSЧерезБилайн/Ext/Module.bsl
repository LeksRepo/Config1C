...
Функция СтатусДоставкиSMS(СтатусСтрокой)
	...
	СоответствиеСтатусов.Вставить("queued", Перечисления.СтатусыДоставкиSMS.Новое);
	СоответствиеСтатусов.Вставить("wait", Перечисления.СтатусыДоставкиSMS.Отправляется);
	СоответствиеСтатусов.Вставить("accepted", Перечисления.СтатусыДоставкиSMS.Отправлено);
	СоответствиеСтатусов.Вставить("delivered", Перечисления.СтатусыДоставкиSMS.Доставлено);
	СоответствиеСтатусов.Вставить("failed", Перечисления.СтатусыДоставкиSMS.НеДоставлено);
