...
Процедура ПриВыполненииОбновленияИнформационнойБазы(СтандартнаяОбработка) Экспорт
...
Процедура ПриЗавершенииРаботыСистемы(Предупреждения) Экспорт
	...
	Если ПредлагатьОбновлениеИнформационнойБазыПриЗавершенииСеанса = Истина Тогда
		...
		ПараметрыПредупреждения.Вставить("ОчищатьПредупрежденияДругихОбработчиков", Истина);
