...
Процедура ПриНастройкеВариантовОтчетов(Настройки) Экспорт
	...
	Отчет = МодульВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.АнализОпроса);
	МодульВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, Отчет, Истина);
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "");
	...
	Вариант.НастройкиДляПоиска.НаименованияПараметровИОтборов =
		НСтр("ru = 'Опрос
		|Вид отчета'");
	Вариант.Описание = НСтр("ru = 'Информация о респондентах заполнивших анкеты по опросу,
	                       |количестве ответов на вопросы, количестве данных вариантов ответов.'");
	
	Отчет = МодульВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.АналитическийОтчетПоАнкетированию);
	МодульВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, Отчет, Ложь);
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПросмотрОтветовПростыеВопросы");
	Вариант.Описание = НСтр("ru = 'Информация о том, как отвечали респонденты на простые вопросы.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПросмотрТабличныхВопросовПлоскийВид");
	Вариант.Описание = НСтр("ru = 'Информация о том, как отвечали респонденты на табличные вопросы.
	                              |Выводится в виде списка с группировками.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПросмотрТабличныхВопросовТабличныйВид");
	Вариант.Описание = НСтр("ru = 'Информация о том, как  отвечали респонденты на табличные вопросы.
	                              |Каждый ответ респондента представлен в виде таблицы.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПростыеВопросыКоличествоОтветов");
	Вариант.Описание = НСтр("ru = 'Информация о том, сколько раз был дан вариант ответа на простой вопрос.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПростыеВопросыАгрегируемыеПоказатели");
	Вариант.Описание = НСтр("ru = 'Информация о среднем, минимальном, максимальном ответе на простой вопрос,
	                              |который требует числового ответа.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ТабличныеВопросыКоличествоОтветов");
	Вариант.Описание = НСтр("ru = 'Информация о том, сколько раз был дан варианта ответа для табличных вопросов,
	                              |который требует указания числового значения.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ТабличныеВопросыАгрегируемыеПоказатели");
	Вариант.Описание = НСтр("ru = 'Информация о среднем, минимальном, максимальном ответе в ячейке табличного вопроса,
	                              |который требует указания числового значения.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ПростыеВопросыКоличествоОтветовСравнениеПоОпросам");
	Вариант.Описание = НСтр("ru =  'Сравнительный анализ количества данных вариантов ответов 
	                               |на простые вопросы в разных опросах.'");
	
	Вариант = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, Отчет, "ТабличныеВопросыАгрегируемыеПоказателиСравнениеПоОпросам");
	Вариант.Описание = НСтр("ru =  'Сравнительный анализ агрегируемых показателей ответов в ячейках
