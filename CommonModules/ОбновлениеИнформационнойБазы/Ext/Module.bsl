...
Функция НачальноеЗаполнениеДанных() Экспорт
	...
	Если СтандартнаяОбработка Тогда
		Результат = НачальноеЗаполнениеДанныхВЛокальномРежиме();
	КонецЕсли;
...
Функция ТребуетсяПроверитьЛегальностьПолученияОбновления() Экспорт
	...
	Если НачальноеЗаполнениеДанныхВЛокальномРежиме() Тогда
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПроверкаЛегальностиПолученияОбновления") Тогда
		...
		Обработчик.Процедура = "ОбновлениеИнформационнойБазы.ЗаписатьПодтверждениеЛегальностиПолученияОбновлений";
	КонецЕсли;
...
Функция НачальноеЗаполнениеДанныхВЛокальномРежиме()
