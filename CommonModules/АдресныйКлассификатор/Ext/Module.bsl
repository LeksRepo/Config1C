...
//       * Ошибки   - Структура    - Описание ошибок, ключ - идентификатор части адреса (имя поля из ОбъектАдреса), 
//                                   значение - текст ошибки. Если нет ошибок, то возвращается пустая структура
//       * Варианты - ТаблицаЗначений - Варианты адресных объектов, успешно прошедших проверку. Колонки:
//           ** Код    - Число  - код адресного объекта
//           ** Индекс - Строка - почтовый индекс адресного объекта
//
...
Функция ТекстОшибкиПоискаВИерархииКлассификатора(Знач АдресныйОбъект, Знач ПолеОшибки)
	...
	ИначеЕсли ПолеОшибки = "Корпус" Тогда
		ТекстОшибки = НСтр("ru = 'Корпус (строение, литера) ""%7"" для дома (владения, домовладения) ""%6"" не найден в адресном классификаторе.'");
...
Функция ТипыЧастейЗдания()
	...
	Результат = 
		...
		НоваяСтрокаТаблицы("ЛИТЕРА",     "Литера",
		НоваяСтрокаТаблицы("ЛИТЕР",      "Литера",
