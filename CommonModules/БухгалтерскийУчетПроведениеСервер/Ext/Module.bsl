...
Функция СформироватьПроводкиПрибыльПроизводства(МассивСпецификаций, Движения, Дата, ДатаПередачи, ВызовИзАкта = Ложь) Экспорт
	...
	Пока ВыборкаПоСпецификациям.Следующий() Цикл
		...
		///// З/п дизайнеров
		Если Не ВыборкаПоСпецификациям.Дилерский И ЗначениеЗаполнено(ДатаПередачи) Тогда
		
			НачислитьЗарплатуДизайнеру(ВыборкаПоСпецификациям.Спецификация, Движения, ДатаПередачи);
...
Функция НачислитьЗарплатуДизайнеру(Спецификация, Движения, ДатаПередачи)
	
	Подразделение = Спецификация.Подразделение;
	Движение = Движения.Управленческий.Добавить();
	Движение.Период = ДатаПередачи;
	...
	Движение.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконто.ФизическиеЛица] = Спецификация.Автор.ФизическоеЛицо;
	//Движение.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконто.ВидыНачисленийУдержаний] = Спецификация.ВидыНачисленийУдержаний;
