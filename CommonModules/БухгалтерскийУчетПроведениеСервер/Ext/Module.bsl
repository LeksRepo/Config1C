...
Процедура СписатьСоСкладаГотовойПродукции(МассивСпецификаций, МоментВремени, Подразделение, Движения, Ошибки) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если (Дата < Дата("20170701000000") И Выборка.ПакетУслуг = Перечисления.ПакетыУслуг.ДоставкаДоКлиентаИМонтаж И Выборка.Изделие <> Справочники.Изделия.ДопСоглашение)
