...
//       * СоответствиеПериодичностиПараметров - Соответствие - Настройки полей ввода периодов.
//           ** Ключ     - ПараметрКомпоновкиДанных - Параметр отчета.
//           ** Значение - ПеречислениеСсылка.ДоступныеПериодыОтчета - Доступный период.
//       * ПараметрыПечатиПоУмолчанию - Структура - Параметры печати табличного документа "по умолчанию".
//
