...
Функция УстановитьАвтоматическоеОбновлениеКлючевыхОперацийВРИБ() Экспорт
	Справочники.КлючевыеОперации.УстановитьОбновлениеПредопределенныхДанных(ОбновлениеПредопределенныхДанных.ОбновлятьАвтоматически);
КонецФункции
...
Процедура СформироватьЗапросРасчетаAPDEX(Запрос)
	...
	|	Справочник.КлючевыеОперации КАК КлючевыеОперации
	|ГДЕ
	|	КлючевыеОперации.Ссылка <> ЗНАЧЕНИЕ(Справочник.КлючевыеОперации.ОбщаяПроизводительностьСистемы)
