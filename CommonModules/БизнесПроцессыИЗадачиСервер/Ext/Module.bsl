...
Процедура ПриНастройкеВариантовОтчетов(Настройки) Экспорт
	...
	Отчеты.БизнесПроцессы.НастроитьВариантыОтчета(Настройки);
	Отчеты.ЗависшиеЗадачи.НастроитьВариантыОтчета(Настройки);
	Отчеты.Задания.НастроитьВариантыОтчета(Настройки);
	Отчеты.Задачи.НастроитьВариантыОтчета(Настройки);
	Отчеты.ЗадачиИстекающиеНаДату.НастроитьВариантыОтчета(Настройки);
	Отчеты.ПросроченныеЗадачи.НастроитьВариантыОтчета(Настройки);
