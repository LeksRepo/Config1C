...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	// Сделать.
	// Нужно циклом по метаданным, чтобы не забывать при каждом добавлении документа.
	// } Васильев Александр Леонидович [05.10.2016]
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПриходОбрезков", "Дата","ПриходОбрезков");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РасходОбрезков", "Дата","РасходОбрезков");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.УстановкаНоменклатурыПодразделений", "Дата","УстановкаНоменклатурыПодразделений");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.КорректировкаВзаиморасчетов", "Дата","КорректировкаВзаиморасчетов");
