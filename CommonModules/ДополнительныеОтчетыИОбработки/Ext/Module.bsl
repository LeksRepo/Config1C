...
Функция ПравоДобавления(Знач ДополнительнаяОбработка = Неопределено) Экспорт
	...
	Для Каждого ОбработчикУсловныхВызовов Из ОбработчикиУсловныхВызовов Цикл
		...
		Модуль = ОбщегоНазначения.ОбщийМодуль(ОбработчикУсловныхВызовов);
...
// Параметры для подключения и выполнения внешнего отчета или обработки к программе.
//
// Параметры:
...
//       * ХранилищеОбработки - ХранилищеЗначения - ДвоичныеДанные для подключения.
//       * БезопасныйРежим - Булево - Подключать в безопасном режиме.
//
