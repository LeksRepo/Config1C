	...
	Если Выборка.Следующий() Тогда
		...
		Если ДляПолучения Тогда
			Если Выборка.Протокол = "IMAP" Тогда
				СписокСвойств = "АдресСервераIMAP,ПортIMAP,ИспользоватьSSLIMAP,ПользовательIMAP,ПарольIMAP,ТолькоЗащищеннаяАутентификацияIMAP";
			Иначе
				СписокСвойств = "АдресСервераPOP3,ПортPOP3,ИспользоватьSSLPOP3,Пользователь,Пароль,ТолькоЗащищеннаяАутентификацияPOP3";
			КонецЕсли;
		Иначе
		...
		КонецЕсли;
		СписокСвойств = СписокСвойств + ",Таймаут";
