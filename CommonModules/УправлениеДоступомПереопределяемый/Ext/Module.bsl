...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "СчетаБУ";
	ВидДоступа.Представление = НСтр("ru = 'Чтение по счетам бухгалтерского учета'");
	ВидДоступа.ТипЗначений = Тип("ПланСчетовСсылка.Управленческий");
