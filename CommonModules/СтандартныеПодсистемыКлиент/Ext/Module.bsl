...
Процедура ДействияПередНачаломРаботыСистемы(Отказ) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыКлиента.ИнформационнаяБазаЗаблокированаДляОбновления) Тогда
		Отказ = Истина;
	...
	Если ПараметрыКлиента.НеобходимоОбновлениеПараметровРаботыПрограммы Тогда
		...
		СтандартныеПодсистемыВызовСервера.ЗагрузитьИлиОбновитьПараметрыРаботыПрограммы();
