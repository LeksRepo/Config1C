...
// ЗаписыватьОшибку - Булево - Признак необходимости записывать сообщение в журнал регистрации
//                             при возникновении ошибки при скачивании файла. Например, если
//                             файл отсутствует по заданному пути.
//
