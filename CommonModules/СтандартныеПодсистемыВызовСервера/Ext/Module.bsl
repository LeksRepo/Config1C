...
Процедура ЗагрузитьИлиОбновитьПараметрыРаботыПрограммы() Экспорт
	
	СтандартныеПодсистемыПовтИсп.НеобходимоОбновлениеПараметровРаботыПрограммы().Очистить();
	...
	СтандартныеПодсистемыСервер.ЗагрузитьИлиОбновитьПараметрыРаботыПрограммы();
