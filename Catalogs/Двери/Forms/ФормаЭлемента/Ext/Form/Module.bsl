	...
	Пока ВыборкаИтог.Следующий() Цикл
		...
		Иначе
			...
			Пока Выборка.Следующий() Цикл
				...
				Стр.Вставить("ПоперечнаяТекстура",Выборка.ПоперечнаяТекстура);
		...
		Пока Тип < 4 Цикл
			...
			Для Каждого Элемент Из Элементы Цикл
				...
				Если Элемент.Иконка = Тип Тогда
					...
					Строка = Строка + Элемент.Наименование + "♦" + Элемент.Код + "♦" + Элемент.УменьшениеВставки + "♦" + Элемент.Иконка + "♦" + Число(Элемент.ПоперечнаяТекстура) + "☺";
