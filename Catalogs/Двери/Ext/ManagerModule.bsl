...
Функция ПолучитьСтруктуруПрофиля(Профиль) Экспорт
	...
	Массив[6] = ?(ЗначениеЗаполнено(СтруктураПрофиля.РамкаСредняяСКреплением), СтруктураПрофиля.РамкаСредняяСКреплением.ШиринаДетали, СтруктураПрофиля.РамкаСредняяБезКрепления.ШиринаДетали);
	Массив[7] = ?(ЗначениеЗаполнено(СтруктураПрофиля.РамкаСредняяСКреплением), СтруктураПрофиля.РамкаСредняяСКреплением.ГлубинаПаза, СтруктураПрофиля.РамкаСредняяБезКрепления.ГлубинаПаза);
