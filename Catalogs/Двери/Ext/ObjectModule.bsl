...
Процедура ПередЗаписью(Отказ)
	...
	Для Каждого Строка Из Номенклатура Цикл
		Если Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.ТрекОднополосныйВерхний
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.ТрекОднополосныйНижний 
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.ТрекВерхний
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.ТрекНижний
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.ТрекНаПоворотнуюСистему 	
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.Вертикальный
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.РамкаВерхняя 
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.РамкаНижняя
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.РамкаСредняяБезКрепления
			ИЛИ Строка.Номенклатура.ВидПрофиля = Перечисления.ВидыПрофилей.РамкаСредняяСКреплением 
			ИЛИ Строка.Номенклатура = Справочники.Номенклатура.ШлегельЗолото
			ИЛИ Строка.Номенклатура = Справочники.Номенклатура.ШлегельХром 
			ИЛИ Строка.Номенклатура = Справочники.Номенклатура.ШлегельВенге 
			ИЛИ Строка.Номенклатура = Справочники.Номенклатура.Уплотнитель4мм 
			ИЛИ Строка.Номенклатура = Справочники.Номенклатура.АгтУплотнитель Тогда
			
			Строка.КоличествоСОтходом = (Строка.Ширина / 1000);
			
		ИначеЕсли Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.ЛДСП10
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.ЛДСП16 
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.АГТПанель
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.МДФ
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.Зеркало 
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.Стекло
			ИЛИ Строка.Номенклатура.НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.ЩитМебельный Тогда
			
			Строка.КоличествоСОтходом = ((Строка.Ширина * Строка.Длина) / 1000000);
