...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	//	ПроизводственноеПодразделение = ПолучитьПроизводственноеПодразделение(Подразделение);
	//	
	//КонецЕсли;
	
	//Если ДанныеЗаполнения.Свойство("ВысотаПроема") Тогда
	//	
	//	ВысотаПроема = ДанныеЗаполнения.ВысотаПроема;
	//	
	//КонецЕсли;
	//
	//Если ДанныеЗаполнения.Свойство("ШиринаПроема") Тогда
	//	
	//	ШиринаПроема = ДанныеЗаполнения.ШиринаПроема;
	//	
	//КонецЕсли;
	...
	//ПроизводственноеПодразделение = ЛексСервер.ПолучитьПодразделениеПоРегиону(Регион, Перечисления.ВидыПодразделений.Производство);
...
Процедура ЗаполнитьШлегели(КоличествоШлегель, КоличествоСтрок)
	...
	Если КоличествоСтрок = 0 Тогда
		...
		НоваяСтрока.Ширина =  Количество * 2 * ВысотаПроема; //?(Количество >= 3, Количество + 2, Количество * 2) * ВысотаПроема;
		НоваяСтрока.Количество = 1;
		НоваяСтрока.ДобавленоВручную = Истина;
	Иначе
		Для Каждого Элемент Из СписокНоменклатуры Цикл
			Если Элемент.Номенклатура = Справочники.Номенклатура.ШлегельВенге 
				...
				Иначе
					Элемент.Ширина = Количество * 2 * ВысотаПроема; //?(Количество >= 3, Количество + 2, Количество * 2) * ВысотаПроема;
