...
Процедура СоздатьФайл(ВладелецФайла)
	...
	ВладелецСпецификация = ТипЗнч(ВладелецФайла) = Тип("ДокументСсылка.Спецификация");
	ВладелецСлужебнаяЗаписка = ТипЗнч(ВладелецФайла) = Тип("ДокументСсылка.СлужебнаяЗаписка"); 
