...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВлияетНаПроем.Доступность = (Объект.ВидИзделия <> Перечисления.ВидыИзделийПоКаталогу.ОсновнойЭлемент 
...
Процедура ВидИзделияПриИзменении(Элемент)
	...
	Элементы.ВлияетНаПроем.Доступность = (Объект.ВидИзделия <> ПредопределенноеЗначение("Перечисление.ВидыИзделийПоКаталогу.ОсновнойЭлемент") 
