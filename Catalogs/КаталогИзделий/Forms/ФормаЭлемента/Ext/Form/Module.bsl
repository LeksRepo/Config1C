...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИЛИ (Объект.ВидИзделияПоКаталогу = Справочники.ВидыИзделийПоКаталогу.Козырек)
	...
	И Объект.ВидИзделияПоКаталогу <> Справочники.ВидыИзделийПоКаталогу.КухняНижний
	...
	Элементы.Угловой.Доступность = (Объект.ВидИзделия = Перечисления.ВидыИзделийПоКаталогу.КухняВерхний 
	ИЛИ Объект.ВидИзделия = Перечисления.ВидыИзделийПоКаталогу.КухняНижний
	ИЛИ Объект.ВидИзделияПоКаталогу = Справочники.ВидыИзделийПоКаталогу.КухняНижний
...
Процедура ВидИзделияПоКаталогуПриИзменении(Элемент)
	...
	ИЛИ Объект.ВидИзделияПоКаталогу = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.Козырек")
	...
	И Объект.ВидИзделияПоКаталогу <> ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КухняНижний")
	...
	ИЛИ Объект.ВидИзделияПоКаталогу = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КухняНижний")
