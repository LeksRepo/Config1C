...
Процедура ВидимостьНастроек()
	...
	Элементы.СтраницаОтсеков.Доступность = КорневойВид = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ОсновнойЭлемент");
	...
	Элементы.Корпусный.Доступность = (КорневойВид <> ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КухняНижний")
	И КорневойВид <> ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КухняВерхний")
	И КорневойВид <> ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.Комод")
	И КорневойВид <> ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.НадстройкаКомода"));
	
	Элементы.СтраницаХарактеристик.Видимость = КорневойВид = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ОсновнойЭлемент");
