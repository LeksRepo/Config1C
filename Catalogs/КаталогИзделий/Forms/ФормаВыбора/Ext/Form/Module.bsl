...
&НаСервере
Процедура УстановитьПараметрыЗапроса(Изделие)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ДоступныеВидыИзделий", ДоступныеВидыИзделий);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьПараметрыЗапроса(Параметры.Изделие);
	...
	Если Параметры.Свойство("ВидИзделияПоКаталогу") И ТипЗнч(Параметры.ВидИзделияПоКаталогу) = Тип("СправочникСсылка.ВидыИзделийПоКаталогу") Тогда
		...
		Если Параметры.Свойство("МассивИзделий") Тогда
			...
			|
			|ВЫБРАТЬ
			|		НесовместимостьИзделийПоКаталогу.Изделие
			|ИЗ
			|	РегистрСведений.НесовместимостьИзделийПоКаталогу КАК НесовместимостьИзделийПоКаталогу
			|ГДЕ
			|	НесовместимостьИзделийПоКаталогу.НесовместимостимоеИзделие В(&МассивИзделий)";
			...
			ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
			ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных("Код");
			...
			ОтборГруппы = ГруппаОтбора.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ОтборГруппы.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Ссылка");
			ОтборГруппы.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
			ОтборГруппы.ПравоеЗначение = МассивНесовместимых;
			ОтборГруппы.Использование = Истина;
			
			ОтборГруппы = ГруппаОтбора.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ОтборГруппы.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ВидИзделияПоКаталогу");
			ОтборГруппы.ВидСравнения = ВидСравненияКомпоновкиДанных.ВИерархии;
			ОтборГруппы.ПравоеЗначение = МассивНесовместимых;
			ОтборГруппы.Использование = Истина;
						
			Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", Новый Цвет(252,0,0));
...
Процедура СписокВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
	...
	Если НЕ ТекущиеДанные.Свойство("СсылкаОформлениеЯчейки") ИЛИ 
		(ТекущиеДанные.Свойство("СсылкаОформлениеЯчейки") И НЕ ТекущиеДанные.СсылкаОформлениеЯчейки.ИспользованиеЦветаТекста) Тогда 
