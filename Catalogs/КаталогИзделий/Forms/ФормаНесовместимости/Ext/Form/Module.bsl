...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокНесовместимости.ТипЗначения = Новый ОписаниеТипов("СправочникСсылка.КаталогИзделий, СправочникСсылка.ВидыИзделийПоКаталогу");
...
Процедура ЗаписатьНаСервере(Список, Изделие)
	...
	Для Каждого Элемент Из Список Цикл
		...
		Если ТипЗнч(Элемент.Значение) = Тип("СправочникСсылка.КаталогИзделий") Тогда
