...
&НаСервере
Процедура УстановитьПараметрыЗапроса(ТипНоменклатуры, СтрокаПоиска)
	...
	ВыборНоменклатуры.Параметры.УстановитьЗначениеПараметра("ТипНоменклатуры", ТипНоменклатуры);
...
Процедура КаталогНоменклатурыПриАктивизацииСтроки(Элемент)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		УстановитьПараметрыЗапроса(ГруппаНоменклатуры,"");
