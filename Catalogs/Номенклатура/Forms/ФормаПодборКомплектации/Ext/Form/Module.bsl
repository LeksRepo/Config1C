...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("НомГруппа") Тогда
		НомГруппа = Параметры.НомГруппа;	
	Иначе
		НомГруппа = "";
	КонецЕсли;
	
	ВыборНоменклатуры.Параметры.УстановитьЗначениеПараметра("ТипНоменклатуры", "");
	ВыборНоменклатуры.Параметры.УстановитьЗначениеПараметра("НомГруппа", НомГруппа);
	...
	Если Параметры.Свойство("Режим") И Параметры.Режим = 1 Тогда
