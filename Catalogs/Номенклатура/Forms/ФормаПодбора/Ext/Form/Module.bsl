...
Процедура УстановитьПараметрыЗапроса(РодительНоменклатуры, СтрокаПоиска = "")
	...
	ВыборНоменклатуры.Параметры.УстановитьЗначениеПараметра("ПраваяНоменклатура", ПраваяНоменклатура);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПраваяНоменклатура") Тогда
		
		Если Параметры.ПраваяНоменклатура Тогда
			 ПраваяНоменклатура = 2;
		Иначе
			 ПраваяНоменклатура = 1;
		КонецЕсли;
		
	Иначе
		ПраваяНоменклатура = 0;
	КонецЕсли;
	...
	Если НЕ СкладскойУчет Тогда
		Элементы.ВыборНоменклатуры.ПодчиненныеЭлементы.ВыборНоменклатурыОстатокНаСкладе.Видимость = Ложь;
	КонецЕсли;
