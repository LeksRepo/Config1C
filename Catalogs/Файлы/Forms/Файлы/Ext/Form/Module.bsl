...
Процедура ПриОткрытии(Отказ)
	Элементы.СоздатьФайлСоСканера.Видимость = РаботаСФайламиСлужебныйКлиент.ДоступнаКомандаСканировать();
...
Процедура ПапкиПриАктивизацииСтроки(Элемент)
	...
	Если Элементы.Папки.ТекущаяСтрока <> ТекущаяПапка Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, НастройкиПравПапки(Элементы.Папки.ТекущаяСтрока));
		Элементы.СоздатьПапку.Доступность = ИзменениеПапок;
		Элементы.ПапкиКонтекстноеМенюСоздатьПапку.Доступность = ИзменениеПапок;
		Элементы.ПапкиКонтекстноеМенюСкопироватьПапку.Доступность = ИзменениеПапок;
		Элементы.ПапкиУстановитьПометкуУдаленияПапки.Доступность = ИзменениеПапок;
	...
	Если Элементы.Папки.ТекущаяСтрока = Неопределено Или Элементы.Папки.ТекущаяСтрока.Пустая() Тогда
		...
		Элементы.СоздатьФайлИзШаблона.Доступность = Ложь;
		Элементы.СоздатьФайлСоСканера.Доступность = Ложь;
		Элементы.КонтекстноеМенюСписокСоздатьФайл.Доступность = Ложь;
		
		Элементы.ФормаСкопироватьФайл.Доступность = Ложь;
		Элементы.СписокКонтекстноеМенюСкопироватьФайл.Доступность = Ложь;
		
		Элементы.ФормаУстановитьПометкуУдаленияФайла.Доступность = Ложь;
		Элементы.СписокКонтекстноеМенюУстановитьПометкуУдаленияФайла.Доступность = Ложь;
		
		Элементы.КонтекстноеМенюПапкиИмпортФайлов.Доступность = Ложь;
		Элементы.КонтекстноеМенюСписокИмпортФайлов.Доступность = Ложь;
		Элементы.КонтекстноеМенюПапкиИмпортПапки.Доступность = Ложь;
		Элементы.КонтекстноеМенюСписокИмпортПапки.Доступность = Ложь;
	Иначе
		Элементы.ГруппаСоздать.Доступность = ДобавлениеФайлов;
		Элементы.СоздатьФайл.Доступность = ДобавлениеФайлов;
		Элементы.СоздатьФайлИзШаблона.Доступность = ДобавлениеФайлов;
		Элементы.СоздатьФайлСоСканера.Доступность = ДобавлениеФайлов;
		Элементы.КонтекстноеМенюСписокСоздатьФайл.Доступность = ДобавлениеФайлов;
		
		Элементы.ФормаСкопироватьФайл.Доступность = ДобавлениеФайлов;
		Элементы.СписокКонтекстноеМенюСкопироватьФайл.Доступность = ДобавлениеФайлов;
		
		Элементы.ФормаУстановитьПометкуУдаленияФайла.Доступность = ПометкаУдаленияФайлов;
		Элементы.СписокКонтекстноеМенюУстановитьПометкуУдаленияФайла.Доступность = ПометкаУдаленияФайлов;
		
		Элементы.КонтекстноеМенюПапкиИмпортФайлов.Доступность = ДобавлениеФайлов;
		Элементы.КонтекстноеМенюСписокИмпортФайлов.Доступность = ДобавлениеФайлов;
		Элементы.КонтекстноеМенюПапкиИмпортПапки.Доступность = ДобавлениеФайлов;
		Элементы.КонтекстноеМенюСписокИмпортПапки.Доступность = ДобавлениеФайлов;
	КонецЕсли;
...
Процедура Подписать(Команда)
	...
	ДанныеФайла = РаботаСФайламиСлужебныйВызовСервера.ПолучитьДанныеФайлаИРабочийКаталог(Элементы.Список.ТекущаяСтрока);
...
Процедура Зашифровать(Команда)
	...
	РаботаСФайламиСлужебныйКлиент.Зашифровать(Обработчик, ДанныеФайла);
...
Процедура СделатьКомандыНедоступными()
	...
	Элементы.ПеренестиВПапку.Доступность = Ложь;
	Элементы.КонтекстноеМенюСписокПеренестиВПапку.Доступность = Ложь;
	...
	Элементы.ФормаСохранитьВместеСПодписьюКонтекст.Доступность = Ложь;
	...
	Элементы.ФормаДобавитьПодписьИзФайлаКонтекст.Доступность = Ложь;
...
Процедура УстановитьДоступностьКоманд(РедактируетТекущийПользователь, Редактирует, ПодписанЭП, Зашифрован)
	...
	Элементы.ЗакончитьРедактирование.Доступность = ИзменениеФайлов И РедактируетТекущийПользователь;
	Элементы.КонтекстноеМенюСписокЗакончитьРедактирование.Доступность = ИзменениеФайлов И РедактируетТекущийПользователь;
	
	Элементы.СохранитьИзменения.Доступность = ИзменениеФайлов И РедактируетТекущийПользователь;
	Элементы.КонтекстноеМенюСписокСохранитьИзменения.Доступность = ИзменениеФайлов И РедактируетТекущийПользователь;
	
	Элементы.Освободить.Доступность = ИзменениеФайлов И Не Редактирует.Пустая();
	Элементы.КонтекстноеМенюСписокОсвободить.Доступность = ИзменениеФайлов И Не Редактирует.Пустая();
	
	Элементы.Занять.Доступность = ИзменениеФайлов И Редактирует.Пустая() И НЕ ПодписанЭП;
	Элементы.КонтекстноеМенюСписокЗанять.Доступность = ИзменениеФайлов И Редактирует.Пустая() И НЕ ПодписанЭП;
	
	Элементы.Редактировать.Доступность = ИзменениеФайлов И НЕ ПодписанЭП И НЕ РедактируетДругой;
	Элементы.КонтекстноеМенюСписокРедактировать.Доступность = ИзменениеФайлов И НЕ ПодписанЭП И НЕ РедактируетДругой;
	
	Элементы.ПеренестиВПапку.Доступность = ИзменениеФайлов И НЕ ПодписанЭП;
	Элементы.КонтекстноеМенюСписокПеренестиВПапку.Доступность = ИзменениеФайлов И НЕ ПодписанЭП;
	
	Элементы.ФормаПодписать.Доступность = ИзменениеФайлов И Редактирует.Пустая();
	Элементы.ФормаПодписатьКонтекст.Доступность = ИзменениеФайлов И Редактирует.Пустая();
	
	Элементы.ФормаСохранитьВместеСПодписью.Доступность = ПодписанЭП;
	Элементы.ФормаСохранитьВместеСПодписьюКонтекст.Доступность = ПодписанЭП;
	
	Элементы.ФормаЗашифровать.Доступность = ИзменениеФайлов И Редактирует.Пустая() И НЕ Зашифрован;
	Элементы.ФормаЗашифроватьКонтекст.Доступность = ИзменениеФайлов И Редактирует.Пустая() И НЕ Зашифрован;
	
	Элементы.ФормаРасшифровать.Доступность = ИзменениеФайлов И Зашифрован;
	Элементы.ФормаРасшифроватьКонтекст.Доступность = ИзменениеФайлов И Зашифрован;
	
	Элементы.ФормаДобавитьПодписьИзФайла.Доступность = ИзменениеФайлов И Редактирует.Пустая();
	Элементы.ФормаДобавитьПодписьИзФайлаКонтекст.Доступность = ИзменениеФайлов И Редактирует.Пустая();
	
	Элементы.ОбновитьИзФайлаНаДиске.Доступность = ИзменениеФайлов И Не ПодписанЭП;
	Элементы.КонтекстноеМенюСписокОбновитьИзФайлаНаДиске.Доступность = ИзменениеФайлов И Не ПодписанЭП;
