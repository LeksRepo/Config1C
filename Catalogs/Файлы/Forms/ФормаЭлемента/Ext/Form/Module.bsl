...
Процедура ПриОткрытии(Отказ)
	...
	Если ТипВладельца = Тип("ДокументСсылка.Спецификация") Тогда
		...
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.Эскиз"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.Макет3D"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.МонтажнаяСхема"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ЦеховаяСхема"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ЗамерныйЛист"));
		
	ИначеЕсли ТипВладельца = Тип("ДокументСсылка.Замер") Тогда
		
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ЗамерныйЛист"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ФотоЗамера"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.БытоваяТехника"));

	ИначеЕсли ТипВладельца = Тип("СправочникСсылка.Номенклатура") Тогда
		
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ТекстураНоменклатуры"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ВекторныйФайл"));
		
	ИначеЕсли ТипВладельца = Тип("ДокументСсылка.СлужебнаяЗаписка") Тогда
		
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.СканДокумента"));
		
	ИначеЕсли ТипВладельца = Тип("СправочникСсылка.КаталогИзделий") Тогда
		
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ОсновнаяКартинка"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.КартинкаЛевая"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.КартинкаПравая"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.Макет3D"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ЦеховаяСхема"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.МонтажнаяСхема"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.КрышаЛевая"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.КрышаПравая"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ВзрывСхемаЛевая"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ВзрывСхемаОсновная"));
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.ВзрывСхемаПравая"));
		
	ИначеЕсли ТипВладельца = Тип("СправочникСсылка.Контрагенты") Тогда
		
		МассивДоступныхВидовФайла.Добавить(ПредопределенноеЗначение("Перечисление.ВидыПрисоединенныхФайлов.Логотип"));	
		
	КонецЕсли;
	
	Если МассивДоступныхВидовФайла.Количество() > 0 Тогда
		
		Элементы.ВидФайла.СписокВыбора.Очистить();
		Элементы.ВидФайла.СписокВыбора.ЗагрузитьЗначения(МассивДоступныхВидовФайла);
		
	Иначе
		
		Элементы.ВидФайла.РежимВыбораИзСписка = Ложь;
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.ВидФайла) Тогда
		
		СтандартнаяОбработка = Ложь;
		Отказ = Истина;
		
		Сообщить("Вид файла не выбран");
