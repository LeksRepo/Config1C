	...
	Пока Выборка.Следующий() Цикл
		...
		Если НЕ Выборка.Изделие = Справочники.Изделия.Переделка Тогда
			...
			Если Выборка.УслугаМонтаж Тогда
				...
				Если Выборка.СвоиМонтажи Тогда // Бренд дилер со своими монтажами
					...
					Проводка.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконто.СтатьиДР] = Справочники.СтатьиДоходовРасходов.ДоходыОтБрендДилеровНаПроизводство;
					Проводка.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконто.СпецификацияДоговор] = Выборка.Спецификация;
					...
					Проводка.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.СтатьиДР] = Справочники.СтатьиДоходовРасходов.РасходыНаПроизводствоМебельногоКомплектаБрендДилер;
