...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если НЕ Отказ Тогда
		...
		БухгалтерскийУчетПроведениеСервер.СформироватьПрибыльПоСпецификациям(МассивСпецификаций, Движения, Дата, Дата); //Вторая дата нужна только потому, что в акте есть ДатаПередачи
