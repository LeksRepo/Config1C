...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	|	СостояниеОССрезПоследних.ПервоначальнаяСтоимость КАК СтараяСтоимость,
	|	тчДок.НомерСтроки,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Выборка.ПроверкаПодразделения) Тогда
			...
			СтрокаТаблицы = НовыйДокумент.ОсновныеСредства.Найти(Выборка.ОсновноеСредство);
			...
			Проводки.СрокАмортизации = Выборка.НовыйСрокАмортизации;
			//////
