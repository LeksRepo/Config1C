...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СписокНоменклатурыПоставщик.СписокВыбора.ЗагрузитьЗначения(ПолучитьПоставщиков());
	
КонецПроцедуры

&НаСервере
Функция ПолучитьПоставщиков()
	...
	|			ИЛИ Контрагенты.ПрочийПоставщик)
...
Функция ПолучитьНастройкиНоменклатуры(Номенклатура, Подразделение)
	...
	Стр.Вставить("РозничнаяПрошлая", 0);
