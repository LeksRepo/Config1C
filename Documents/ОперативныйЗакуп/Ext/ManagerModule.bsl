...
Функция ПечатьОперативныйЗакуп(Документ, ОбъектыПечати) Экспорт
	...
	Запрос.УстановитьПараметр("НарядЗадание", Документ[0].НарядЗадание);
...
Функция ПечатьЗаявкаПоставщику(Документ, ОбъектыПечати) Экспорт
	...
	|ИЗ
	|	(ВЫБРАТЬ
	|		ОперативныйЗакупНоменклатураПодЗаказ.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|		ОперативныйЗакупНоменклатураПодЗаказ.КоличествоПоставщик КАК КоличествоПоставщик,
	|		ОперативныйЗакупНоменклатураПодЗаказ.Номенклатура КАК Номенклатура,
	|		ОперативныйЗакупНоменклатураПодЗаказ.Цена * ОперативныйЗакупНоменклатураПодЗаказ.КоличествоПоставщик КАК Сумма,
	|		ОперативныйЗакупНоменклатураПодЗаказ.Поставщик КАК Поставщик
	|	ИЗ
	|		Документ.ОперативныйЗакуп.НоменклатураПодЗаказ КАК ОперативныйЗакупНоменклатураПодЗаказ
	|	ГДЕ
	|		ОперативныйЗакупНоменклатураПодЗаказ.Ссылка В(&Ссылки)
	|		И ОперативныйЗакупНоменклатураПодЗаказ.КоличествоПоставщик > 0
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	|		ОперативныйЗакупСписокНоменклатуры.ЕдиницаИзмерения,
	|		ОперативныйЗакупСписокНоменклатуры.КоличествоПоставщик,
	|		ОперативныйЗакупСписокНоменклатуры.Номенклатура,
	|		ОперативныйЗакупСписокНоменклатуры.Цена * ОперативныйЗакупСписокНоменклатуры.КоличествоПоставщик,
	|		ОперативныйЗакупСписокНоменклатуры.Поставщик
	|	ИЗ
	...
	|		И ОперативныйЗакупСписокНоменклатуры.КоличествоПоставщик > 0) КАК втДанные
	|
	|СГРУППИРОВАТЬ ПО
	|	втДанные.Номенклатура,
	|	втДанные.ЕдиницаИзмерения,
