...
Процедура ЗаполнитьНаСервере()
	...
	|		КОНЕЦ + 0.49999 - УжеСкомплектовано.Количество КАК ЧИСЛО(15, 0)) КАК Количество,
	...
	|	"""" КАК Комментарий,
	|	УжеСкомплектовано.Количество КАК УжеСкомплектовано
	|ИЗ
	...
	|			ТОГДА СпецификацияСписокМатериаловПодЗаказ.Количество - УжеСкомплектовано.Количество
