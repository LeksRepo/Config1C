...
Процедура ЗаполнитьНаСервере()
	...
	|	КОНЕЦ КАК Номенклатура,
	|	СУММА(ВЫРАЗИТЬ(СпецификацияСписокНоменклатуры.Количество / ЕСТЬNULL(НоменклатураПодразделенийСрезПоследних.ОсновнаяПоСкладу.КоэффициентБазовых, 1) + 0.49999 КАК ЧИСЛО(15, 0))) КАК КоличествоВсегоТребуется
