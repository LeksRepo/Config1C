...
Процедура ЗаполнитьНаСервере()
	...
	//			   |		ПО ВТМатериалыСоСтоимостью.Номенклатура = НоменклатураПодразделений.Номенклатура";
				   //|ГДЕ
				   //|	НоменклатураПодразделений.Подразделение = &Подразделение
				   //|	И ВЫБОР
				   //|			КОГДА &Поставщик = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
				   //|				ТОГДА ИСТИНА
				   //|			ИНАЧЕ ВТМатериалыСоСтоимостью.Поставщик = &Поставщик
				   //|		КОНЕЦ";
				   //
	...
	//			 |	ВТМатериалыСоСтоимостью.КоличествоСрочно,
	//			 |	ВТМатериалыСоСтоимостью.КоличествоСрочно * ВТМатериалыСоСтоимостью.Цена КАК СтоимостьСрочно,
	//			 |	НоменклатураПодразделений.Подразделение КАК Стоимость
	//			 |ИЗ
	//			 |	ВТМатериалыСоСтоимостью КАК ВТМатериалыСоСтоимостью
	//			 |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НоменклатураПодразделений КАК НоменклатураПодразделений
	//			 |	    ПО ВТМатериалыСоСтоимостью.Номенклатура = НоменклатураПодразделений.Номенклатура
