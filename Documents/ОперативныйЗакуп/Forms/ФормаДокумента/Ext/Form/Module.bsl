...
Процедура ЗаполнитьНаСервере()
	...
	|	Спец.Сумма,
	|	Спец.Поставщик,
	|	Спец.Номенклатура.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	...
	|
	|УПОРЯДОЧИТЬ ПО
	|	Спец.Номенклатура.Наименование";
...
Процедура НоменклатураПодЗаказПриАктивизацииСтроки(Элемент)
	...
	Если Данные <> Неопределено Тогда
		...
		ОтборСтрок = Новый ФиксированнаяСтруктура("Спецификация, БазоваяНом", Данные.Спецификация, Данные.Номенклатура);
