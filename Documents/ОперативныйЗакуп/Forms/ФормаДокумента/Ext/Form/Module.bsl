...
Процедура ЗаполнитьНаСервере()
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	Неноменклатурный.Номенклатура,
	|	Неноменклатурный.Спецификация КАК Спецификация
	|ПОМЕСТИТЬ втЗаказаные
	|ИЗ
	|	Документ.ОперативныйЗакуп.НеноменклатурныйМатериал КАК Неноменклатурный
	|ГДЕ
	|	Неноменклатурный.Заказано
	|	И Неноменклатурный.Ссылка <> &ОперЗакуп
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ втЗаказаные КАК Заказанные
	|		ПО Спец.Ссылка = Заказанные.Спецификация
	|			И Спец.Номенклатура = Заказанные.Номенклатура
	|ГДЕ
	...
	|	И Заказанные.Номенклатура ЕСТЬ NULL
	|
	|УПОРЯДОЧИТЬ ПО
	|	Порядок,
	|	Спец.Ссылка.Номер";
