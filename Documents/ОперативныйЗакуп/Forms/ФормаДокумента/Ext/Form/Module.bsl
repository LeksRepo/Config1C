...
Процедура ЗаполнитьНаСервере()
	...
	|	КОНЕЦ КАК Количество,
	|	ВТДокупитьНаЦех.СсылкаСпец КАК СсылкаСпец,
	|	ВТДокупитьНаЦех.Поставщик КАК Поставщик,
	|	ВЫБОР
	|		КОГДА НЕ ВТДокупитьНаСклад.Номенклатура ЕСТЬ NULL 
	|				И ВТДокупитьНаЦех.Номенклатура ЕСТЬ NULL 
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК НаСклад
	...
	|		ИНАЧЕ ВТДокупитьНаСклад.Номенклатура
	|	КОНЕЦ,
	|	ВТДокупитьНаЦех.СсылкаСпец,
	|	ВТДокупитьНаЦех.Поставщик,
	|	ВЫБОР
	|		КОГДА НЕ ВТДокупитьНаСклад.Номенклатура ЕСТЬ NULL 
	|				И ВТДокупитьНаЦех.Номенклатура ЕСТЬ NULL 
	|			ТОГДА ИСТИНА
	...
	|	ВТМатериалыСоСтоимостью.НаСклад
