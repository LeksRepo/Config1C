...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Иначе
		...
		Если СуммаОплаты <> 0 И ДатаПриемаОплаты < '20140901' Тогда
			...
			Проводка.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.ФизическиеЛица] = ЛексСервер.ПолучитьЗначениеНастройкиПользователя(Автор, ПланыВидовХарактеристик.НастройкиПользователей.ФизЛицо);
		...
		Если НЕ ЗначениеЗаполнено(ПервыйЗамер) Тогда
			...
			Проводки.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.ФизическиеЛица] = ЛексСервер.ПолучитьЗначениеНастройкиПользователя(Автор, ПланыВидовХарактеристик.НастройкиПользователей.ФизЛицо);
...
Функция ДвиженияПродажиФакт()
	...
	Проводка.Сотрудник = ЛексСервер.ПолучитьЗначениеНастройкиПользователя(Автор, ПланыВидовХарактеристик.НастройкиПользователей.ФизЛицо);;
	Проводка.Офис = Офис;
