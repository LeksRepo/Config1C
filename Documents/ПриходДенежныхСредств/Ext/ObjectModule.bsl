...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	КонецЦикла;
	Для каждого Значение Из СчетКт.ВидыСубконто Цикл
		Если Значение.ВидСубконто=ПланыВидовХарактеристик.ВидыСубконто.СпецификацияДоговор Тогда
			Индекс = ПроверяемыеРеквизиты.Найти("Субконто"+Значение.НомерСтроки+"Кт");
			ПроверяемыеРеквизиты.Удалить(Индекс);
		КонецЕсли;
	КонецЦикла;
	Для каждого Значение Из СчетДт.ВидыСубконто Цикл
		Если Значение.ВидСубконто=ПланыВидовХарактеристик.ВидыСубконто.СпецификацияДоговор Тогда			
			Индекс = ПроверяемыеРеквизиты.Найти("Субконто"+Значение.НомерСтроки+"Дт");
			ПроверяемыеРеквизиты.Удалить(Индекс);
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
