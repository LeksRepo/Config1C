...
Процедура ЗаполнитьНаСервереДизайнеры()
	...
	Запрос.Текст = 
		...
		ТаблицаПараметров = Документы.НачислениеЗаработнойПлаты.ПолучитьЗначениеПараметров(МассивПараметров, Справочники.Должности.ДизайнерКонсультант, Объект.НачалоПериода);
