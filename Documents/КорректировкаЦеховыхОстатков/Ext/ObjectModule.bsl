...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Строка Из СписокНоменклатуры Цикл
		...
		Если НЕ Строка.Номенклатура.Базовый Тогда
			...
			ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(Ошибки, "Объект.СписокНоменклатуры["+(Строка.НомерСтроки-1)+"].Номенклатура", "Замените номенклатуру на базовую: "+Строка.Номенклатура.Наименование);
