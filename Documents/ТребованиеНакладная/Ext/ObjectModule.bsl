...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЗначениеЗаполнено(НарядЗадание) И НЕ РаскройНаНарядСформирован() Тогда
		
		 ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Раскрой на наряд не сформирован. Запись документа запрещена.");
		 Отказ = Истина;
