...
Функция СформироватьТаблицуМатериалов(НарядЗадание) Экспорт
	...
	|			ТОГДА НарядЗаданиеСписокЛистовНоменклатуры.Номенклатура.ШиринаБезТорцовки * НарядЗаданиеСписокЛистовНоменклатуры.Номенклатура.ДлинаБезТорцовки / 1000000 * НарядЗаданиеСписокЛистовНоменклатуры.Количество
	|		ИНАЧЕ НоменклатураПодразделенийСрезПоследних.ОсновнаяПоСкладу.КоэффициентБазовых * НарядЗаданиеСписокЛистовНоменклатуры.Количество
	|	КОНЕЦ,
