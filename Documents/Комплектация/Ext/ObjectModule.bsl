...
Функция ПолучитьСуммуКомплектации()
	...
	Запрос.Текст = 
		...
		|	СписокНоменклатуры.КоличествоСклад * ЦеныНоменклатурыПоПодразделениямСрезПоследних.Розничная + СписокНоменклатуры.КоличествоСклад * ЦеныНоменклатурыПоПодразделениямСрезПоследних.Розничная КАК Стоимость
		...
		|		ПО СписокНоменклатуры.Номенклатура = ЦеныНоменклатурыПоПодразделениямСрезПоследних.Номенклатура
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
