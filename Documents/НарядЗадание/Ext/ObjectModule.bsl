...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если НЕ Отказ Тогда
		...
		ДвиженияИзделияВЦеху(МассивСпецификаций);
...
Процедура ДвиженияИзделияВЦеху(МассивСпецификаций)
	...
	Для Каждого Спец Из МассивСпецификаций Цикл
		...
		Проводка.Сумма = Спец.ЗабалансоваяСтоимость;
		Проводка.СчетДт = ПланыСчетов.Управленческий.ИзделияВЦеху;
		Проводка.КоличествоДт = 1;
		Проводка.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.ДокументВзаиморасчетов] = Спец;
