		...
		Пока ВыборкаВидМатериала.Следующий() Цикл
			...
			Пока ВыборкаНоменклатура.Следующий() Цикл
				...
				Пока ВыборкаСпецификация.Следующий() Цикл
					...
					ОбластьСпецификацияСтрока.Параметры.НомерСпецификации = 
					СтроковыеФункцииКлиентСервер.УдалитьПовторяющиесяСимволы(ВыборкаСпецификация.НомерСпецификации, "0");
			...
			Если НЕ РезультатЗапроса.Пустой() Тогда
				...
				Пока ВыборкаМатериалЗаказчика.Следующий() Цикл
					...
					ОбластьМатериалЗаказчикаСтрока.Параметры.НомерСпецификации =
					СтроковыеФункцииКлиентСервер.УдалитьПовторяющиесяСимволы(ВыборкаМатериалЗаказчика.НомерСпецификации, "0");
