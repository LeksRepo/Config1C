...
Функция ПечатьНарядЗадания(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
		...
		Отчеты.ПроизводственныйОтчет.ВывестиПросроченноеИзготовление(ТабДок, ВыборкаДокументы.ДатаНаряда, ВыборкаДокументы.Подразделение);
		
		//////////////////////////////// ИЗДЕЛИЯ НА СКЛАДЕ ГОТОВОЙ ПРОДУКЦИИ
		Отчеты.ПроизводственныйОтчет.ВывестиИзделияНаСкладеГотовойПродукции(ТабДок, ВыборкаДокументы.ДатаНаряда, ВыборкаДокументы.Подразделение);
		
		//////////////////////////////// ГРАФИК ОТГРУЗОК
		Отчеты.ПроизводственныйОтчет.ВывестиГрафикОтгрузок(ТабДок, ВыборкаДокументы.ДатаНаряда, ВыборкаДокументы.Подразделение);
		
		//////////////////////////////// ГРАФИК ДОСТАВОК
		Отчеты.ПроизводственныйОтчет.ВывестиГрафикДоставок(ТабДок, ВыборкаДокументы.ДатаНаряда, ВыборкаДокументы.Подразделение);
		
		//////////////////////////////// ГРАФИК МОНТАЖЕЙ
		Попытка
			Отчеты.ПроизводственныйОтчет.ВывестиГрафикМонтажей(ТабДок, ВыборкаДокументы.ДатаИзготовленияНаряда, ВыборкаДокументы.Подразделение);
		Исключение
		КонецПопытки;
