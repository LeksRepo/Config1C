...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПечатьЯщики") Тогда
		ПодготовитьПечатнуюФорму("ПечатьЯщики", "Ящики", "Документ.НарядЗадание.ПечатьЯщики",
		МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);
	КонецЕсли;
...
Процедура ПодготовитьПечатнуюФорму(Знач ИмяМакета, ПредставлениеМакета, ПолныйПутьКМакету = "", МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода)
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, ИмяМакета) Тогда
		...
		ИначеЕсли ИмяМакета = "ПечатьЯщики" Тогда
			ТабДок = ПечатьЯщики(МассивОбъектов, ОбъектыПечати);	
		КонецЕсли;
...
Функция ПечатьЯщики(МассивОбъектов, ОбъектыПечати) Экспорт
	
	ТабДок = Новый ТабличныйДокумент;
	ТабДок.ИмяПараметровПечати = "ПараметрыПечати_ПечатьЯщики";
	ТабДок.АвтоМасштаб = Истина;
	ТабДок.ОтображатьСетку = Ложь;
	ТабДок.Защита = Истина;
	ТабДок.ТолькоПросмотр = Истина;
	...
	Макет = Документы.НарядЗадание.ПолучитьМакет("ПечатьЯщики");
	ОбластьЗаголовок = Макет.ПолучитьОбласть("Заголовок");
	...
	|ГДЕ
	|	НЕ Ящики.НомерСтроки ЕСТЬ NULL
	|	И СписокСпец.Ссылка В(&Наряды)
	|	И ВЫБОР
	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаСпец.Следующий() Цикл
			...
			ОбластьСпецификация.Параметры.Спецификация = ВыборкаСпец.Спецификация; 
