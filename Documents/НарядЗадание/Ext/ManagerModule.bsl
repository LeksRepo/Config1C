...
Функция ПечатьНарядЗадания(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока ВыборкаДокументы.Следующий() Цикл
		...
		ВывестиМерныйМатериал(ТабДок, МассивСпецификаций);
...
Функция ВывестиМерныйМатериал(ТабДок, Ссылка) Экспорт
	...
	Для Каждого Спец Из Ссылка Цикл
	
		ТЗМерныйМатериал = Спец.МерныйМатериал;
		...
		Если ТЗМерныйМатериал.Количество() <> 0 Тогда
			...
			Для каждого Строка Из ТЗМерныйМатериал Цикл
				...
				ОбластьМерныйМатериалСтрока.Параметры.НомерСтроки = НомерСтроки;
