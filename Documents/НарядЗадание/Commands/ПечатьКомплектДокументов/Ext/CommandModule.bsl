...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ПроверитьПодразделение(ПараметрКоманды) Тогда
...
&НаСервере
Функция ПроверитьПодразделение(Документы)
...
Функция ОпределитьМакеты(Документы)
	...
	МассивМакетов.Добавить("ПечатьМатериалПоПарковкам");
	...
	Для Каждого Док ИЗ Документы Цикл 
		Если Док.ОстаткиЛистовогоМатериала.Количество()>0 Тогда
			МассивМакетов.Добавить("ПечатьОбрезки");
			Прервать;
		КонецЕсли;
	КонецЦикла;
