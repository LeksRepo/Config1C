...
&НаСервере
Процедура ЗаполнитьНоменклатуройСерверПередЗаписью(Объект) Экспорт
...
&НаСервере
Функция ЗаполнитьЛистовойМатериал(Объект)
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	//RonEXI: Разобраться с ТекущийОбъект. Почемуто не записывается нифига.
	//ЗаполнитьНоменклатуройСерверПередЗаписью(ТекущийОбъект);
