...
Функция СформироватьДвиженияОсновныеСредства()
	...
	|ИЗ
	|	Документ.ПоступлениеМатериаловУслуг.ОсновныеСредства КАК ПоступлениеМатериаловУслугОсновныеСредстваТЗ
	|ГДЕ
	|	ПоступлениеМатериаловУслугОсновныеСредстваТЗ.Ссылка = &Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
