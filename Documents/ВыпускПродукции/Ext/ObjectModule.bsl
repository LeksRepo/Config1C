...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для каждого Спецификация Из МассивСерийные Цикл
		...
		Для каждого Строка Из Спецификация.СписокИзделийПоКаталогу Цикл
	...
	Для каждого Изделие Из МассивИзделий Цикл
		...
		Проводка.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.Номенклатура] = Изделие.НоменклатураСерийногоИзделия;
