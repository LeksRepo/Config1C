...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	//|	ОбщиеОстатки.КоличествоТребуется КАК КоличествоТребуется,
	...
	//|		ПО СпецификацияСписокНоменклатуры.Номенклатура = ОбщиеОстатки.Номенклатура
	//|ГДЕ
	//|	СпецификацияСписокНоменклатуры.Ссылка В(&Ссылка)
	//|	И СпецификацияСписокНоменклатуры.Номенклатура.ВидНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ВидыНоменклатуры.Материал)
	//|
	...
	//|	СпецификацияСписокНоменклатуры.Ссылка,
	//|	ОбщиеОстатки.КоличествоТребуется,
	//|	ОбщиеОстатки.КоличествоОстаток,
	//|	ОбщиеОстатки.СуммаОстаток
	//|ИТОГИ ПО
	//|	Номенклатура";
	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаПоСпецификациям.Следующий() Цикл
			...
			Если ВыборкаПоСпецификациям.КоличествоОстаток > 0 Тогда
				...
				Если ВыборкаПоСпецификациям.КоличествоОстаток >= ВыборкаПоСпецификациям.Количество Тогда
					КоличествоСписываемое = ВыборкаПоСпецификациям.Количество;
				Иначе
					КоличествоСписываемое = ВыборкаПоСпецификациям.Количество / ВыборкаПоСпецификациям.Количество * ВыборкаПоСпецификациям.КоличествоОстаток;
				КонецЕсли;
