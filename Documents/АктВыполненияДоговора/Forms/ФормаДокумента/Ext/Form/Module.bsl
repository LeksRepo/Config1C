...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Объект.Ссылка.Пустая()
		И ЕстьМонтаж(Объект.Договор) Тогда
...
Функция ЕстьМонтаж(ДоговорСсылка)
	
	Возврат ДоговорСсылка.Спецификация.ПакетУслуг = Перечисления.ПакетыУслуг.ДоставкаДоКлиентаИМонтаж;
