...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	СформироватьПоказателиТехнологов(СтруктураРеквизитов);
...
Функция СформироватьПоказателиТехнологов(СтруктураРеквизитов)
	
	Технолог = СтруктураРеквизитов.Технолог;
	Производство = СтруктураРеквизитов.Производство;
	КоличествоБалов = ОбщегоНазначения.ПолучитьЗначениеРеквизита(СтруктураРеквизитов.Изделие, "БалСложности");
	...
	Если ЗначениеЗаполнено(Технолог) и КоличествоБалов > 0 Тогда
		...
		ДобавитьПоказательСотрудника(Технолог, Перечисления.ВидыПоказателейСотрудников.СуммаРазмещенныхЗаказов, СтруктураРеквизитов.СуммаДокумента, Производство);
