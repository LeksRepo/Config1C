...
Функция ПередИзменениемДанных()
	...
	Если ЗначениеЗаполнено(Объект.Подразделение) И ЗначениеЗаполнено(Объект.Дата) Тогда
		...
		Для Каждого Строка Из Объект.ТаблицаДней Цикл
			Если Строка.Норматив > 0 ИЛИ Строка.КоличествоКоробов > 0 ИЛИ Строка.КоличествоДеталей > 0 Тогда
...
&НаКлиенте
Процедура ЗаполнитьДанными(КоличествоКоробов, Норматив, КоличествоДеталей) Экспорт
