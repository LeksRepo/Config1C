...
Функция ПечатьСписаниеОС(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	|ГДЕ
	|	СписаниеОСОсновныеСредства.Ссылка В(&МассивОбъектов)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ИЗ
	|	тчДок КАК тчДок
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СостояниеОсновныхСредств.СрезПоследних КАК СостояниеОсновныхСредствСрезПоследних
