...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	УправлениеПечатьюКлиент.ВыполнитьКомандуПечати("Документ.РеализацияМатериалов", "СчетНаОплатуПокупателю", ПараметрКоманды, ПараметрыВыполненияКоманды, Неопределено);
...
Процедура СделатьПроверкуДокументов(СписокДокументов )
	...
	|ГДЕ
	|	РеализацияМатериалов.Ссылка В(&СписокДокументов)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
