...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Элементы.Офис.Доступность = ЗначениеЗаполнено(Объект.Подразделение);
...
Процедура ОфисНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ЗначениеОтбора.Вставить("Владелец",Объект.Подразделение);
	ЗначениеОтбора.Вставить("Активность",Истина);
	
	ПараметрыВыбора = Новый Структура("Отбор", ЗначениеОтбора);
	ОткрытьФорму("Справочник.Офисы.ФормаВыбора", ПараметрыВыбора, Элемент);
...
Процедура ОфисПриИзменении(Элемент)
	...
	Если Объект.Офис <> ПредопределенноеЗначение("Справочник.Офисы.ПустаяСсылка") Тогда		
