...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Контрагент.Дилер Тогда
		 Инд = ПроверяемыеРеквизиты.Найти("Офис");
...
Функция ДвиженияПродажиФакт()
	...
	|	Обрезки.Номенклатура.Серийная,
	|	Обрезки.Сумма,
	|	0
	|ИЗ
	|	Документ.РеализацияМатериалов.ОбрезкиХлыстовогоМатериала КАК Обрезки
	|ГДЕ
	|	Обрезки.Ссылка = &Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
