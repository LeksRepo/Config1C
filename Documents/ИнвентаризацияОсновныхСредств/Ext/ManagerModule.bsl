...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "МакетИнв1") Тогда
		
		ПодготовитьПечатнуюФорму("МакетИнв1", "Инвентаризация основных средств (Инв-1)", "Документ.ИнвентаризацияОсновныхСредств.МакетИнв1",
...
Функция ПечатьИнв1(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	ПараметрыШапка.Вставить("МОЛ",Ссылка.ФизическоеЛицо);
...
Процедура ПодготовитьПечатнуюФорму(Знач ИмяМакета, ПредставлениеМакета, ПолныйПутьКМакету = "", МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода)
	...
	Если ИмяМакета = "МакетИнв1" Тогда
		
		ТабДок = ПечатьИнв1(МассивОбъектов, ОбъектыПечати);
