...
Функция ПриходныйОрдер(МассивОбъектов, ОбъектыПечати) Экспорт	
    ...
    ОбластьСписокПлатежейВыделить = Макет.ПолучитьОбласть("СписокПлатежейВыделить");
    ...
    Для Каждого Документ Из МассивОбъектов Цикл
		...
		|	ВЫБОР
		|		КОГДА СпНоменклатуры.Поставщик <> ЦеныНоменклатурыСрезПоследних.Поставщик
		|			ТОГДА ИСТИНА
		|		ИНАЧЕ ЛОЖЬ
		|	КОНЕЦ КАК Выделить
		|ПОМЕСТИТЬ Аванс
		...
		Если Таблица.Количество() > 0 Тогда
			...
			Для Каждого Строка Из Таблица Цикл
				...
				Если Строка.Выделить Тогда
				   Область = ОбластьСписокПлатежейВыделить;
			    Иначе
				   Область = ОбластьСписокПлатежей;
				КонецЕсли;  
