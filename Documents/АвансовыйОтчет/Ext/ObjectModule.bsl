...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ОперативныйЗакуп") Тогда
		...
		|ВЫБРАТЬ
		|	Неном.Номенклатура,
		|	Неном.Номенклатура.Наименование,
		|	Неном.Поставщик,
		|	Неном.Спецификация.Номер,
		|	Неном.Комментарий,
		|	Неном.КоличествоКупить,
		|	Неном.Цена,
		|	Неном.Спецификация,
		|	1
		|ИЗ
		|	Документ.ОперативныйЗакуп.НеноменклатурныйМатериал КАК Неном
		|ГДЕ
		|	Неном.Ссылка = &Документ
		|	И Неном.КоличествоКупить > 0
		|
		|УПОРЯДОЧИТЬ ПО
		|	Порядок,
