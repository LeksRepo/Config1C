...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если НЕ Отказ Тогда
		...
		Если НЕ Проведен И (СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Ознакомлен 
			ИЛИ СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Выполнена
			ИЛИ СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Утверждаю) Тогда
