...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если НЕ Объект.Проведен И (Объект.СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Ознакомлен 
		ИЛИ Объект.СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Выполнена) Тогда
