...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		Если НЕ ДоступностьФормы И (Объект.Автор <> Пользователь) И (Объект.Адресат <> Пользователь) 
			ИЛИ (Объект.СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Выполнена
			ИЛИ Объект.СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Ознакомлен
			ИЛИ Объект.СтатусСлужебнойЗаписки = Перечисления.СтатусыСлужебныхЗаписок.Утверждаю) Тогда
