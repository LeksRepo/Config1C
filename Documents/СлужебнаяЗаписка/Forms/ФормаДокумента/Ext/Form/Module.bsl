...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	АвторСтрока = Пользователь.Наименование;
	
	УстановитьВидыСлужебныхЗаписок();
...
Функция УстановитьВидыСлужебныхЗаписок()
	...
	Иначе
		...
		СписокВыбораВидСЗ.Добавить(Перечисления.ВидыСлужебнойЗаписки.ИнформированиеЗаявка);
		СписокВыбораВидСЗ.Добавить(Перечисления.ВидыСлужебнойЗаписки.ПретензияЗаявление);
		СписокВыбораВидСЗ.Добавить(Перечисления.ВидыСлужебнойЗаписки.НарушенияВРаботе);
		СписокВыбораВидСЗ.Добавить(Перечисления.ВидыСлужебнойЗаписки.ОплатаСчета);
...
Функция СобратьМассив(Массив, Разделитель)
	...
	Возврат ПолучитьСтрокуИзМассиваПодстрокНеПропускатьПустые(Массив, Разделитель);
...
Функция ПолучитьСтрокуИзМассиваПодстрокНеПропускатьПустые(Массив, Разделитель = ",") Экспорт
	...
	Для Каждого Элемент Из Массив Цикл
		...
		Если Не Первый Тогда
			РазделительПодстрок = Разделитель;	
		КонецЕсли;
...
Процедура АрхивПриИзменении(Элемент)
	...
	Если Объект.Архив Тогда
		Текст = "Установлен признак ""В архив""";
	Иначе
		Текст = "Снят признак ""В архив""";
	КонецЕсли;
	
	ТекстОтвета = СформироватьТекстАрхив(Текст);
