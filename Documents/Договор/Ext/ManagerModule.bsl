...
Функция ПечатьАктПередачи(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	|	МАКСИМУМ(докДоговор.Контрагент) КАК ФИОКлиента,
	...
	|	МАКСИМУМ(докДоговор.Контрагент.Телефон) КАК Телефон,
	|	МАКСИМУМ(докДоговор.Контрагент.ТелефонДополнительный) КАК ТелефонДополнительный,
