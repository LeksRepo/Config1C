...
Функция Запрос(МассивОбъектов, ДоговорДилера) Экспорт
	...
	Если ДоговорДилера Тогда
		...
		|	ДоговорДилера.Спецификация.НазваниеИзделия КАК Изделие,
	...
	Иначе
		...
		|	Договор.Спецификация.НазваниеИзделия КАК Изделие,
...
Функция ПечатьАктПередачи(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	|	МАКСИМУМ(докДоговор.Спецификация.НазваниеИзделия) КАК Изделие,
