...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения) Тогда
		...
		Если ДанныеЗаполнения.УслугаМонтаж Тогда
			ДатаУстановитьНеПозднее 	= ?(ЗначениеЗаполнено(ДанныеЗаполнения.ДатаМонтажа), ДанныеЗаполнения.ДатаМонтажа + 30*24*3600, Неопределено);
		КонецЕсли;
	КонецЕсли;
