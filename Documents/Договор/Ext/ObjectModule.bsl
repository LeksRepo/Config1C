...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	ВидИзделия = Спецификация.Изделие.ВидИзделия;
	...
	СвойстваСпецификации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Спецификация, "Контрагент, Подразделение, СуммаДокумента, ВнутренняяСтоимостьСпецификации, Автор, Дилерский");
	...
	Если НЕ СвойстваСпецификации.Дилерский Тогда
		...
		ПроводкаПоИзделию.ВидИзделия = ВидИзделия;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Спецификация.Изделие = Справочники.Изделия.Детали Тогда
		
		Отказ = Истина;
		ТекстСообщения = "Для " + Спецификация + " нельзя ввести договор.";
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, ДоговорСсылка);
