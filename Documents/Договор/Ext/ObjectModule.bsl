...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если НЕ ЗначениеЗаполнено(Спецификация.НазваниеИзделия) Тогда
		Отказ= Истина;
		ТекстСообщения = "Укажите название изделия в " + Спецификация;
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения)
		...
		НазваниеИзделия = ДанныеЗаполнения.НазваниеИзделия;
		
		Если НЕ ЗначениеЗаполнено(НазваниеИзделия) Тогда
			
			СтандартнаяОбработка = Ложь;
			Отказ = Истина;
			ТекстСообщения = "Укажите название изделия";
