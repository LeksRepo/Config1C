...
Процедура ИзменитьПостоянныйКлиент(Команда)
	...
	СтруктураСкидка = ЛексСервер.ПолучитьСкидкуДоговора(Объект.Подразделение, Объект.Дата, Объект.СуммаДокументаБезСкидки, ВидОплаты, Объект.Офис, Объект.Контрагент, Объект.Ссылка, Ложь, Объект.ПостоянныйКлиент);
