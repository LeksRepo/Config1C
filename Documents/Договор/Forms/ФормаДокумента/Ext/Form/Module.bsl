...
Функция ПолучитьСкидкуПостоянногоКлиента(Контрагент)
...
Процедура ПересчитатьСкидку()
	...
	СкидкаПостоянногоКлиента = ПолучитьСкидкуПостоянногоКлиента(Объект.Контрагент);
	...
	Объект.ПроцентСкидки = Объект.ПроцентСкидки + СкидкаПостоянногоКлиента;
	Объект.СуммаДокумента = Объект.СуммаДокументаБезСкидки - (Объект.СуммаДокументаБезСкидки * Объект.ПроцентСкидки / 100);
	
	Если СкидкаПостоянногоКлиента > 0 И ЗначениеЗаполнено(Объект.Контрагент) Тогда
		
		ТекстПодсказки = "Постоянный клиент: скидка + " + СкидкаПостоянногоКлиента + " %";
		Зеленый = Новый Цвет(0,128,0);
		
		ЭтаФорма.Элементы.Контрагент.ЦветТекстаЗаголовка = Зеленый;
		ЭтаФорма.Элементы.ПроцентСкидки.ЦветТекстаЗаголовка = Зеленый;
		ЭтаФорма.Элементы.ПроцентСкидки.ЦветТекста = Зеленый;
		ЭтаФорма.Элементы.Контрагент.РасширеннаяПодсказка.Заголовок = ТекстПодсказки;
		ЭтаФорма.Элементы.ПроцентСкидки.РасширеннаяПодсказка.Заголовок = ТекстПодсказки;  
	Иначе
		ЭтаФорма.Элементы.Контрагент.ЦветТекстаЗаголовка = Новый Цвет(0,0,0);
		ЭтаФорма.Элементы.ПроцентСкидки.ЦветТекстаЗаголовка = Новый Цвет(0,0,0);
		ЭтаФорма.Элементы.ПроцентСкидки.ЦветТекста = Новый Цвет(0,0,0);
		ЭтаФорма.Элементы.Контрагент.РасширеннаяПодсказка.Заголовок = "";
		ЭтаФорма.Элементы.ПроцентСкидки.РасширеннаяПодсказка.Заголовок = ""; 
	КонецЕсли
