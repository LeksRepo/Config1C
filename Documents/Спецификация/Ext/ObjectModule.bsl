...
Функция ЗаполнитьЗабалансовуюСтоимость()
	...
	Если Дилерский Тогда
		...
		Если ЗначениеЗаполнено(НаценкаДилера) Тогда
...
Функция ПолучитьНаценкуДилера()
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	НаценкиДилерамСрезПоследних.Наценка
	|ИЗ
	|	РегистрСведений.НаценкиДилерам.СрезПоследних(&МоментВремени, Контрагент = &Контрагент) КАК НаценкиДилерамСрезПоследних
	|ГДЕ
	|	НаценкиДилерамСрезПоследних.Контрагент = &Контрагент";
