...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если (НЕ Ссылка.Проведен И ЗначениеЗаполнено(ДатаИзготовления) И Изделие <> Справочники.Изделия.Переделка)
		ИЛИ (Ссылка.Проведен И (Ссылка.ДатаИзготовления <> ДатаИзготовления)) Тогда
