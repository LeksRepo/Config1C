...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЭтотОбъект.СписокМатериалы.Количество() > 0 Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Реквизиты.Кант = Выборка.Наименование;
			Реквизиты.СокрКант = Выборка.КраткоеНаименование;
			
		КонецЕсли;
		
		Если Выборка.Следующий() Тогда
			
			Реквизиты.Кромка045мм = Выборка.Наименование;
			Реквизиты.Сокр045мм = Выборка.КраткоеНаименование;
			
		КонецЕсли;
		
		Если Выборка.Следующий() Тогда 
			
			Реквизиты.Кромка2мм = Выборка.Наименование;
			Реквизиты.Сокр2мм = Выборка.КраткоеНаименование;
