...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Дилерский Тогда
		...
		Если ПакетУслуг = Перечисления.ПакетыУслуг.ДоставкаДоКлиентаИМонтаж Тогда
			...
			Сообщение.Текст 	= "Для дилеров услуга монтажа не доступна.";
			Сообщение.Поле 	= "Объект.ПакетУслуг";
			Сообщение.Сообщить();
	...
	Если ДеньНедели(ДатаОтгрузки) = 7 Тогда
		...
		Сообщение 			= Новый СообщениеПользователю;
		Сообщение.Текст 	= "В воскресенье изделия не отгружаем. Выберите другой день";
