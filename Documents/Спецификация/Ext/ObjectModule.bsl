...
Функция ПревышенЛимитНарядов()
	...
	Если НЕ (НаборЗаписей.Количество() = 0) Тогда
		КоличествоДеталей = НаборЗаписей[0].КоличествоДеталей;
	КонецЕсли;
	...
	ВсегоДеталей = СтруктураНорматива.КоличествоДеталей + КоличествоДеталей;
	...
	ВсегоДоставок = СтруктураНорматива.КоличествоДоставок + КоличествоДоставок;
...
Функция ДвиженияЦеховойЛимит()
	...
	ЗаписьЛимит.КоличествоДоставок = ПолучитьКоличествоДоставок();
	...
	Если НаборЗаписей.Количество() = 0 Тогда
		ЗаписьЛимит.КоличествоДеталей = 0;
	Иначе
		ЗаписьРаскрой = НаборЗаписей[0];
		ЗаписьЛимит.КоличествоДеталей = ЗаписьРаскрой.КоличествоДеталей;
	КонецЕсли;
