...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ИначеЕсли УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЗамерныйЛистИнженеру") Тогда
		
		ПодготовитьПечатнуюФорму("ЗамерныйЛистИнженеру", "Замерный Лист", "Документ.Спецификация.ЗамерныйЛистИнженеру",   
		МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);	
...
Процедура ПодготовитьПечатнуюФорму(Знач ИмяМакета, ПредставлениеМакета, ПолныйПутьКМакету = "", МассивОбъектов, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода)
	...
	ИначеЕсли ИмяМакета = "ЗамерныйЛистИнженеру" Тогда
		
		ТабДок = ПечатьЗамерныйЛистИнженеру(МассивОбъектов, ОбъектыПечати);
	...
	ИначеЕсли ИмяМакета = "Комплектация" Тогда
		...
		ТабДок = ПечатьКомплектация(МассивОбъектов, ОбъектыПечати);
...
Функция ПечатьЗамерныйЛист(Выборка, ОбъектыПечати)
	...
	Пока ВыборкаФайлов.Следующий() Цикл
		...
		Если РасширениеКартинки(Расширение) Тогда
			...
			ОбластьКартинка.Рисунки.К1.Верх = 5;
			ОбластьКартинка.Рисунки.К1.Лево = 5;
...
Функция ПечатьЗамерныйЛистИнженеру(Выборка, ОбъектыПечати)
	
	ТабДок = Новый ТабличныйДокумент;
	
	ТабДок.ИмяПараметровПечати = "ПараметрыПечати_ЗамерныйЛистИнженеру";
	ТабДок.АвтоМасштаб = Ложь;
	ТабДок.ОтображатьСетку = Ложь;
	ТабДок.Защита = Истина;
	ТабДок.ТолькоПросмотр = Истина;
	...
	Макет = Документы.Спецификация.ПолучитьМакет("ЗамерныйЛистИнженеру");
	ОбластьКартинка = Макет.ПолучитьОбласть("Картинка");
...
Функция ПечатьКомплектация(МассивДокументов, ОбъектыПечати) Экспорт
	
	ТабДок = Новый ТабличныйДокумент;
	ТабДок.ИмяПараметровПечати = "ПараметрыПечати_Комплектация";
	ТабДок.АвтоМасштаб = Истина;
	ТабДок.ОриентацияСтраницы = ОриентацияСтраницы.Ландшафт;
	ТабДок.ОтображатьСетку = Ложь;
	ТабДок.Защита = Истина;
