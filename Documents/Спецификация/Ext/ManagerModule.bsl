...
Функция ПечатьСчетНаОплатуПокупателю(МассивДокументов, ОбъектыПечати) Экспорт
	...
	ОбластьСуммаПрописью.Параметры.ИтоговаяСтрока = "Всего наименований "+  Товары.Количество() + ", на сумму " + СокрЛП(Формат(СуммаКПрописи,ФорматнаяСтрока)) + " " +ВалютаДокумента.НаименованиеПолное;
