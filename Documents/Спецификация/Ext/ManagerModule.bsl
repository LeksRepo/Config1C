...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ВывестиНеноменклатурныйМатериал(ТабДок, Выборка.Ссылка);
	...
	Для каждого д Из МассивДокументов Цикл
		...
		ВывестиМерныйМатериал(ТабДок, д);
		ВывестиНеноменклатурныйМатериал(ТабДок, д);
			
		КонецЕсли; // Если д.СписокМатериалы.Количество() = 0 Тогда
