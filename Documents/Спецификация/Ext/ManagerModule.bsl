...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбластьЗаголовок.Параметры.Комментарий 			= "Договор: " + "тут будет номер договора" + " /  Адрес: " + Спецификация.АдресМонтажа;
...
Функция ПечатьДверь(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл 
		...
		ОбластьЗаголовок.Параметры.Комментарий 			= "Договор: " + "тут будет номер договора" + " /  Адрес: " + Выборка.Ссылка.АдресМонтажа;
