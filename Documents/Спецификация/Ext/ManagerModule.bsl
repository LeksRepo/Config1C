...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Для каждого Спецификация Из МассивДокументов Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			МатериалЛДСП = (Материал = "10 ЛДСП" ИЛИ Материал = "16 ЛДСП"
			ИЛИ Материал = "10 ЛДСП+10 ЛДСП"
			ИЛИ Материал = "16 ЛДСП+10 ЛДСП"
			ИЛИ Материал = "16 ЛДСП+16 ЛДСП"
			ИЛИ Материал = "22 ЛДСП"
			ИЛИ Материал = "26 ЛДСП");
			Пуфик = Материал = "Пуфик";
			
			Если Материал = "ФасадАГТ"
				ИЛИ Материал = "ФасадМДФ"
				ИЛИ Материал = "ФасадЛДСП"
				ИЛИ Материал = "ФасадАлюминиевый" Тогда
	...
	КонецЦикла; // Для каждого Спецификация Из МассивДокументов
