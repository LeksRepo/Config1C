...
Функция ПолучитьСтруктуруНорматива(Период, Подразделение) Экспорт
	...
	Данные.Вставить("КоличествоДеталей", 0);
	Данные.Вставить("КоличествоДеталейПлан", 0);
	Данные.Вставить("КоличествоДоставок", 0);
	...
	|	ЕСТЬNULL(ЦеховойЛимит.КоличествоДеталейОборот, 0) КАК КоличествоДеталей,
	|	ЕСТЬNULL(ЦеховойЛимит.КоличествоДеталейПланОборот, 0) КАК КоличествоДеталейПлан,
	|	ЕСТЬNULL(ЦеховойЛимит.КоличествоДоставокОборот, 0) КАК КоличествоДоставок,
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Данные.КоличествоДеталей = Выборка.КоличествоДеталей;
		Данные.КоличествоДеталейПлан = Выборка.КоличествоДеталейПлан;
		Данные.КоличествоДоставок = Выборка.КоличествоДоставок;
		Данные.КоличествоДоставокПлан = Выборка.КоличествоДоставокПлан;
