...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаПоМатериалам.Следующий() Цикл
			...
			КоличествоДеталей = ДетальныеЗаписи.Количество();
			ОбластьШапка.Параметры.Деталей = КоличествоДеталей;
			ТабДок.Вывести(ОбластьШапка);
		...
		Если ВыборкаЯщиков.Количество() > 0 Тогда
			...
			КоличествоДеталей 									= ВыборкаЯщиков.Количество();
			ОбластьШапкаЯщиков.Параметры.Деталей 	= КоличествоДеталей;
			...
			Если ТаблицаФасадовЯщиков.Количество() > 0 Тогда
				...
				ОбластьПустаСтрока = Макет.ПолучитьОбласть("ПустаяСтрока");
				ТабДок.Вывести(ОбластьПустаСтрока);
				КоличествоДеталей 												= ТаблицаФасадовЯщиков.Количество();
				ОбластьШапкаФасадовЯщиков.Параметры.Деталей 	= КоличествоДеталей;
