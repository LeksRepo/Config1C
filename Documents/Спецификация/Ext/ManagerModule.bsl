	...
	Для Каждого Ящик Из Документ.СписокЯщики Цикл
		...
		Для Каждого ДетальСхема Из Схема.Детали Цикл
			...
			Если ДетальСхема.Тип = Перечисления.ВидыДеталейЯщиков.Фасад 
			   ...
			   НоваяДеталь.Ручка = Ящик.РучкаНоменклатура; 
	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаСписокНоменклатуры.Следующий() Цикл
			...
			Если ВыборкаСписокНоменклатуры.КоличествоСклад <> ВыборкаСписокНоменклатуры.ЗатребованоСклад
				...
				ОбластьОтклоненияСтрока.Параметры.ОтклонениеСклад = (ВыборкаСписокНоменклатуры.ЗатребованоСклад - ВыборкаСписокНоменклатуры.КоличествоСклад);
				ОбластьОтклоненияСтрока.Параметры.ОтклонениеЦех = (ВыборкаСписокНоменклатуры.ЗатребованоЦех - ВыборкаСписокНоменклатуры.КоличествоЦех);
