...
Процедура ПечатьСпецификации_Фасады(Спецификация, ТабДок, НазваниеЗоны)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СборныйРамочныйФасад Тогда
			...
			ОбластьСтрокаЯчейка.Параметры.ВысотаДетали = Выборка.ВысотаДетали + Выборка.ШиринаСборнойРамки * 2 - 16;
			ОбластьСтрокаЯчейка.Параметры.ШиринаДетали = Выборка.ШиринаДетали + Выборка.ШиринаСборнойРамки * 2 - 16;
