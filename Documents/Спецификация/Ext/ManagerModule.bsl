	...
	Пока Выборка.Следующий() Цикл
		...
		Пока ВыборкаСписокНоменклатуры.Следующий() Цикл
			...
			Если ВыборкаСписокНоменклатуры.КоличествоСклад <> ВыборкаСписокНоменклатуры.ЗатребованоСклад
				...
				ОбластьОтклоненияСтрока.Параметры.ОтклонениеСклад = (ВыборкаСписокНоменклатуры.КоличествоСклад - ВыборкаСписокНоменклатуры.ЗатребованоСклад);
				ОбластьОтклоненияСтрока.Параметры.ОтклонениеЦех = (ВыборкаСписокНоменклатуры.КоличествоЦех - ВыборкаСписокНоменклатуры.ЗатребованоЦех);
