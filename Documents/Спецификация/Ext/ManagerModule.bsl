...
Функция ПолучитьКоличествоДнейНаИзготовление(Спецификация) Экспорт
	...
	Если ДнейНаИзготовление < 7 Тогда
		ДнейНаИзготовление = 7;	
	КонецЕсли;
...
Функция ПечатьАктГотовности(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Если ТабдокЛево.Области.Количество() > 0 Тогда
		...
		Если ТабдокПравоКоличествоСтрок > 0 Тогда
			ТабДок.ВставитьОбласть(ТабдокПраво.Область("C1:C6"), ТабДок.Область("R10C8:R"+(10+ТабдокПравоКоличествоСтрок)+"C13"));
		КонецЕсли;
