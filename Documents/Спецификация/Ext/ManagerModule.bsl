...
Функция ВывестиМерныйМатериал(ТабДок, Ссылка) Экспорт
	...
	Если ТЗМерныйМатериал.Количество() = 0 Тогда
		ТЗМерныйМатериал = Новый ТаблицаЗначений;
		ТЗМерныйМатериал.Колонки.Добавить("Номенклатура");
		ТЗМерныйМатериал.Колонки.Добавить("Количество");
		ТЗМерныйМатериал.Колонки.Добавить("НомерИзделия");
		...
		//Для каждого Строка Из Ссылка.СписокНоменклатуры Цикл
		
		Для каждого Дверь Из Ссылка.СписокДверей Цикл
			
			Для каждого Строка Из Дверь.Двери.Номенклатура Цикл
				...
				Если Номенклатура.МестоОбработки = Перечисления.МестоОбработки.ЦехМерный И Номенклатура.ВидНоменклатуры = Перечисления.ВидыНоменклатуры.Материал Тогда
					НоваяСтрока 								= ТЗМерныйМатериал.Добавить();
					НоваяСтрока.Номенклатура 			= Номенклатура;
					НоваяСтрока.Количество 			= Строка.КоличествоСОтходом;
					//НоваяСтрока.НомерИзделия 		= Строка.НомерИзделия;
				КонецЕсли;
		...
		//Для Каждого Строка Из Ссылка.СписокМатериалы Цикл
		//	
	...
	Если ТЗМерныйМатериал.Количество() + ТЗКомплектация.Количество() <> 0 Тогда
