...
Функция РазложитьЯщикиНаДетали(Документ) Экспорт
	...
	Для Каждого Ящик Из Документ.СписокЯщики Цикл
		...
		Для Каждого ДетальСхема Из Схема.Детали Цикл
			...
			Выполнить("НоваяДеталь.ВысотаДетали = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Ящик", ДетальСхема.Высота)); 
			Выполнить("НоваяДеталь.ШиринаДетали = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Ящик", ДетальСхема.Ширина));
			
			Выполнить("НоваяДеталь.Количество = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Ящик", ДетальСхема.Количество));
