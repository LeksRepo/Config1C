...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Для каждого Спецификация Из МассивДокументов Цикл
		...
		|	СпецификацияСписокМатериалы.РасположениеПазов.ПоложениеРучки КАК ПоложениеРучки,
		|	СпецификацияСписокМатериалы.РасположениеПазов.ПоложениеПазов КАК РасложениеПазов
		|ИЗ
...
Функция ПечатьЧертежДвери(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для каждого Дверь Из МассивОбъектов.КартинкаДвери Цикл
...
Функция ПечатьСтеклянныеФасады(МассивДокументов, ОбъектыПечати) Экспорт
	...
	|	СпецификацияСписокМатериалы.Петли,
	|	СпецификацияСписокМатериалы.РасположениеПазов.ПоложениеРучки КАК ПоложениеРучки,
	|	СпецификацияСписокМатериалы.РасположениеПазов.ПоложениеПазов как РасположениеПазов,
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ИначеЕсли УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЧертежДвери") Тогда
		...
		Параметры.Вставить("КартинкаДвери",ПараметрыПечати.КартинкаДвери);
