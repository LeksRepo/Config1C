	...
	Если НЕ Результат.Пустой() Тогда
		...
		Для Каждого Строка ИЗ ТЗ Цикл
			...
			Попытка
				...
				Выполнить("СверлоЛевоЗначение = " + Строка.СверлоЛево);
				Выполнить("СверлоПравоЗначение = " + Строка.СверлоПраво);
			...
			Иначе
				...
				Если ПрошлыеДанные.СверлоЛево <> СверлоЛевоЗначение Тогда
					ОбластьСтрока.Параметры.СверлоЛево = СверлоЛевоЗначение; 	
				КонецЕсли;
				
				Если ПрошлыеДанные.СверлоПраво <> СверлоПравоЗначение Тогда
					ОбластьСтрока.Параметры.СверлоПраво = СверлоПравоЗначение; 	
				КонецЕсли;
