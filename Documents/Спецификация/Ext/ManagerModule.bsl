...
Процедура УстановитьБезОкругленияДоЛистов(СпецификацияСсылка) Экспорт
	
	Спец = СпецификацияСсылка.ПолучитьОбъект();
	Спец.БезОкругленияДоЛистов = НЕ Спец.БезОкругленияДоЛистов;
	Спец.Записать();
