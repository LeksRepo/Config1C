		...
		Пока ВыборкаПоИзделиям.Следующий() Цикл
			...
			Если КоличествоФасадов > 0 Тогда
				...
				Для Каждого Строка Из ТаблицаФасадов Цикл
					...
					ОбластьСтрокаФасады.Параметры.ЦветФасада = Строка.НоменклатураФасада.КраткоеНаименование;
					ОбластьСтрокаФасады.Параметры.Обрамление = Строка.ОбрамлениеФасада.КраткоеНаименование;
					ОбластьСтрокаФасады.Параметры.Ручка = Строка.НоменклатураРучки.КраткоеНаименование;
					ОбластьСтрокаФасады.Параметры.РасположениеРучки = Строка.РасположениеРучки;
					ОбластьСтрокаФасады.Параметры.Механизм1 = Строка.МеханизмФасада.КраткоеНаименование;
					ОбластьСтрокаФасады.Параметры.Демпфер = Строка.Демпфер.КраткоеНаименование;
					...
					ОбластьСтрокаФасады.Параметры.ЛДСП = Строка.НоменклатураЭлемента.КраткоеНаименование;
					ОбластьСтрокаФасады.Параметры.Торцовка = Строка.ТорцовкаЭлемента.КраткоеНаименование;						 
					ОбластьСтрокаФасады.Параметры.ДопЭлемент = Строка.ДопЭлемент.КраткоеНаименование;
