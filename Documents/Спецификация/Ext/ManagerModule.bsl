...
Функция ПечатьСпецификации(МассивДокументов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		|	СпецификацияСписокЯщики.КоличествоРучек * СпецификацияСписокЯщики.КоличествоЯщиков КАК ФасадКоличествоРучек,
		...
		Если ВыборкаЯщиков.Количество() > 0 Тогда
			...
			ТаблицаФасадовЯщиков.Колонки.Добавить("КоличествоРучек");
			...
			Пока ВыборкаЯщиков.Следующий() Цикл
				...
				Если НЕ ВыборкаЯщиков.ВидФасада = "Нет" Тогда
					...
					НоваяСтрока.КоличествоРучек 		= ВыборкаЯщиков.ФасадКоличествоРучек;
...
Функция ПечатьЗаказ(МассивДокументов, ОбъектыПечати) Экспорт
	...
	|	СпецификацияСписокНоменклатуры.Ссылка.ДатаОтгрузки КАК ДатаИзготовления
	|ИЗ
	|	Документ.Спецификация.СписокНоменклатуры КАК СпецификацияСписокНоменклатуры
	|ГДЕ
...
Функция ПерезаполнитьКомплектацию(СсылкаСпецификация) Экспорт
	...
	|	СпецификацияСкладГотовойПродукции.Количество КАК Количество,
	...
	//
	//Для каждого Строка Из СсылкаСпецификация.СписокЯщики Цикл
	//	
	...
	//СтруктураКомплектации = Новый Структура;
	//СтруктураКомплектации.Вставить("Выборка", Выборка);
	//СтруктураКомплектации.Вставить("ТЗ", ТЗ);
