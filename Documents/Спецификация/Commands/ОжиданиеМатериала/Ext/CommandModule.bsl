...
Функция ПередатьНаОжидание(СпецификацияСсылка)
	...
	Если ТекущийСтатус = Перечисления.СтатусыСпецификации.Рассчитывается
		ИЛИ ТекущийСтатус = Перечисления.СтатусыСпецификации.Размещен Тогда	
	...
	Иначе
		Сообщить("На ожидание материала передаются только спецификации со статусами ""Рассчитывается"" или ""Размещен""");
	КонецЕсли;
