...
Функция ОпределительРаскроя(МассивСсылок)
	...
	Для каждого Ссылка Из МассивСсылок Цикл
		...
		Запрос.Текст = 
		"ВЫБРАТЬ РАЗРЕШЕННЫЕ
		|	Спецификация.СтрокаНовогоРаскрояЛДСП
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ЗначениеЗаполнено(Выборка.СтрокаНовогоРаскрояЛДСП) Тогда
				Структура.Вставить("СтрокаНовогоРаскрояЛДСП", Выборка.СтрокаНовогоРаскрояЛДСП);
			КонецЕсли;
