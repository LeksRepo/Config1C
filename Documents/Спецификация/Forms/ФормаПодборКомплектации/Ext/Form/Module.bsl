...
Процедура ВыборНоменклатурыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Иначе
		Данные=ПолучитьДанныеНоменклатуры(Элемент.ТекущиеДанные.Номенклатура);
...
&НаСервере
Функция ПолучитьДанныеНоменклатуры(Ном)
	
	Ст=Новый Структура;
	Ст.Вставить("Номенклатура",Ном);
	Ст.Вставить("ЕдиницаИзмерения",Ном.ЕдиницаИзмерения);
	Ст.Вставить("Кратность",Ном.Кратность);
