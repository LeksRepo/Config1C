...
Функция НайтиНовуюСтрокуФлэш(Спецификация, Команда, Данные = Неопределено)
	...
	ИначеЕсли Команда = "new" Тогда
		...
		СтруктураРаскроя = РегистрыСведений.РаскройДеталей.СформироватьРаскрой(Спецификация);
	...
	ИначеЕсли Команда = "recr" Тогда
		...
		СтруктураРаскроя = РегистрыСведений.РаскройДеталей.СформироватьРаскрой(Спецификация, ТЗ);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяНовойHTML = ЛексСервер.ПолучитьИмяХТМЛ(Справочники.Файлы.ЭтикеткиHtml);
...
Процедура ВыполнитьВернутьВсеДетали()
	...
	СсылкаСпецификация = Элементы.Список.ТекущиеДанные.Ссылка;
	ДанныеОтФлэш = НайтиНовуюСтрокуФлэш(СсылкаСпецификация, "new");
	
	Элементы.КнопкаПоказатьНовыйРаскрой.Документ.url = ЛексКлиент.ПутьHTML(ИмяНовойHTML);
...
Процедура ВыполнитьПерераскрой()
	...
	СсылкаСпецификация = Элементы.Список.ТекущиеДанные.Ссылка;
	ДанныеОтФлэш = НайтиНовуюСтрокуФлэш(СсылкаСпецификация, "recr", ДанныеОтФлэш);
