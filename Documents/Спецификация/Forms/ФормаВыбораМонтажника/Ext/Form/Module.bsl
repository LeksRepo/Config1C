...
Функция Сформировать()
	...
	|ГДЕ
	|	(РабочиеДниМонтажников.Город IS NULL ИЛИ РабочиеДниМонтажников.Город = &ГородРабочий)
    | И (РабочиеДниМонтажников.День IS NULL ИЛИ РабочиеДниМонтажников.День МЕЖДУ &НачалоПериода И &КонецПериода)
	|
	|УПОРЯДОЧИТЬ ПО
	|	ФизЛицо,
	|	День
