...
Процедура ДоступностьНастроек()
	...
	Если Данные <> Неопределено Тогда
		...
		Если ЗначениеЗаполнено(Данные.СхемаЯщика) Тогда
			...
			Элементы.ДекорацияКриволинейныйВыпилПодРучку.Доступность = Элементы.КриволинейныйВыпилПодРучку.Доступность;
			
			Элементы.РучкаЩель.Доступность = ДанныеСхемы.РучкаЩель И ЕстьФасад;
			Элементы.ДекорацияРучкаЩель.Доступность = Элементы.РучкаЩель.Доступность;
