	...
	Если НовыеЯщики Тогда		
		...
		Если РассчитатьФасад Тогда
			Если ЗначениеЗаполнено(Данные.ВысотаЯщика) И ЗначениеЗаполнено(Данные.ПроемЯщика) И Данные.ВидФасада <> "Нет" Тогда
				...
				Выполнить("Данные.ВысотаФасад = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Данные", ДанныеСхемы.ВысотаФасада)); 
				Выполнить("Данные.ШиринаФасад = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Данные", ДанныеСхемы.ШиринаФасада)); 
...
Процедура УстановитьГлубинуЯщика()
	...
	Если Данные.ПроемЯщика > 0 И Данные.ВысотаЯщика > 0 Тогда
		...
		Выполнить("Данные.ГлубинаЯщика = " + ЛексКлиентСервер.ПодставитьОбъектВФормулуЯщика("Данные", ДанныеСхемы.ГлубинаЯщика));	
