	...
	Если Проем > 0 Тогда
		...
		ИначеЕсли ВидЯщика = ПредопределенноеЗначение("Перечисление.ВидыЯщика.Тандембокс") Тогда
			Если Проем >= 279 Тогда
				Данные.ШиринаБоковойСтороны = Проем - 87;
				Данные.ШиринаДно = Проем - 75;
			Иначе
...
Процедура НаименованиеПриИзменении(Элемент)
	...
	//СтруктураЛиста = ПолучитьРазмерыЛиста(НоменклатураМатериала);
	
	//УстановитьМаксимальныеЗначения(СтруктураЛиста);
