...
Функция СформироватьСтрокуРедактор3Д()
	...
	Структура.ГлубинаДетали = ЛексСервер.ЗначениеРеквизитаОбъекта(ТекущиеДанные.Номенклатура, "ГлубинаДетали");
	
	
	
	//ЗаполнитьЗначенияСвойств(Структура, РеквизитыНоменклатуры);
	...
	Для каждого Поле Из Структура Цикл
		...
		Строка3Д = Строка3Д + Строка(Поле.Значение) + "☺";
