...
Процедура УстановитьРазмерыПолотна()
	...
	Если ЗначениеЗаполнено(СтрКромки.Верх) ИЛИ ЗначениеЗаполнено(СтрКромки.Низ) ИЛИ ЗначениеЗаполнено(СтрКромки.Лево) ИЛИ ЗначениеЗаполнено(СтрКромки.Право) Тогда 
		...
		Если ЗначениеЗаполнено(ТекущиеДанные.ШиринаСборнойРамки) Тогда
			...
			Размеры.Вставить("ВычитаемоеДляШирины", ТекущиеДанные.ШиринаСборнойРамки * 2 - 24);
			Размеры.Вставить("ВычитаемоеДляВысоты", ТекущиеДанные.ШиринаСборнойРамки * 2 - 24);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяSWF = Справочники.Файлы.ДеталиFlash.Наименование + "." + Справочники.Файлы.ДеталиFlash.ТекущаяВерсия.Расширение;
