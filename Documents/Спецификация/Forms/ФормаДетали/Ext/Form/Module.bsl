...
Функция ИспользованиеПереключателяКромки(Переключатель, МебельнаяКромка, ЭлементМебельнаяКромка)
	...
	Если Переключатель = "Кант" Тогда
		...
		Если НЕ Клееная Тогда
			...
			Если НЕ Материал = "Столешница" И НЕ Материал = "МДФ" И НЕ СпецФасады И НЕ Пристенок И НЕ Материал = "10 ЛДСП" Тогда
	...
	ИначеЕсли Переключатель = "0.45" Тогда
		...
		Если НЕ Клееная Тогда
			...
			Если НЕ Материал = "Столешница" И НЕ Материал = "МДФ" И НЕ СпецФасады И НЕ Материал = "10 ЛДСП" Тогда
