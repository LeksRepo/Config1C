...
Процедура ВысотаПриИзменении(Элемент)
	...
	ТекущиеДанные = Элементы.Детали.ТекущиеДанные;
	ВысотаСКромкой = ПроверитьНаМинимальныйРазмер(ТекущиеДанные.ВысотаДетали + МассивыНоменклатурныхГрупп.ВычитаемоеДляВысоты, Число(Элемент.ТекстРедактирования), ДанныеДетали.МинимальнаяВысота);
...
Процедура ШиринаПриИзменении(Элемент)
	...
	ШиринаСКромкой = ПроверитьНаМинимальныйРазмер(ТекущиеДанные.ШиринаДетали + МассивыНоменклатурныхГрупп.ВычитаемоеДляШирины, Число(Элемент.ТекстРедактирования), ДанныеДетали.МинимальнаяШирина);
	...
	Если ШиринаСКромкой > МассивыНоменклатурныхГрупп.ШиринаПолотна Тогда
		...
		Если ЭтоСтолешница И НЕ Скругление Тогда
			...
			ТекущиеДанные.ШиринаДетали = МассивыНоменклатурныхГрупп.ШиринаПолотна - ДанныеДетали.ПрипускПостформинг - МассивыНоменклатурныхГрупп.ВычитаемоеДляШирины;
