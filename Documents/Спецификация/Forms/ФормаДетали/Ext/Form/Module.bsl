...
&НаКлиенте
Функция СформироватСтрокуРедактор3Д()
	
	Строка3Д = "";
	
	// команды: init, del, add
	
	ФорматнаяСтрока = "Команда☺ИД☺ВысотаДетали☺ШиринаДетали☺ГлубинаДетали☺ЦветДетали☺
	...
	Для каждого Поле Из Структура Цикл
		...
		Строка3Д = Строка3Д + Поле.Значение + "☺";
		
	КонецЦикла;
	
	//ДанныеДляSWF.Вставить("Команда");
	//ДанныеДляSWF.Вставить("Идентификатор");
	//ДанныеДляSWF.Вставить("ВысотаДетали");
	//ДанныеДляSWF.Вставить("ШиринаДетали");
	//ДанныеДляSWF.Вставить("ГлубинаДетали");
	//ДанныеДляSWF.Вставить("ЦветДетали");
	//ДанныеДляSWF.Вставить("ЦветКромкиСверху");
	//ДанныеДляSWF.Вставить("ЦветКромкиСнизу");
	//ДанныеДляSWF.Вставить("ЦветКромкиСлева");
	//ДанныеДляSWF.Вставить("ЦветКромкиСправа");
	//ДанныеДляSWF.Вставить("РадиусЛевоВерх");
	//ДанныеДляSWF.Вставить("РадиусПравоВерх");
	//ДанныеДляSWF.Вставить("РадиусПравоНиз_1");
...
Функция ОбновитьФлэш()
	...
	Если ЭлементФлэш <> Неопределено И Элементы.Детали.ТекущиеДанные <> Неопределено Тогда
		...
		Строка3Д = СформироватСтрокуРедактор3Д();
