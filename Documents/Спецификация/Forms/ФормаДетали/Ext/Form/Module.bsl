...
Процедура ШиринаСборнойРамкиПриИзменении(Элемент)
	...
	ТекущиеДанные = Элементы.Детали.ТекущиеДанные;
	ТекущиеДанные.ШиринаСборнойРамки = ?(ТекущиеДанные.ШиринаСборнойРамки < 60, 60, ТекущиеДанные.ШиринаСборнойРамки);
	ТекущиеДанные.ШиринаСборнойРамки = ?(ТекущиеДанные.ШиринаСборнойРамки > 100, 100, ТекущиеДанные.ШиринаСборнойРамки);
	УстановитьРазмерыПолотна();
	ПосчитатьЧистыйРазмер();
	ОбновитьФлэш();
