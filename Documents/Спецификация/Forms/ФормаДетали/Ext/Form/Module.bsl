...
Процедура МатериалПриИзменении(Элемент)
	...
	Если НовыеДетали Тогда
		ДанныеДетали = ПолучитьДанныеДетали(ТекущиеДанные.Материал);
	КонецЕсли;	
...
Процедура НоменклатураНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НовыеДетали Тогда
		НомГруппы = ДанныеДетали.НомГруппы;	
	Иначе
