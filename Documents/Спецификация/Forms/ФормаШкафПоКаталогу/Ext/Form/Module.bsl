...
Процедура УстановитьДоступность(ВидИзделия)
	...
	Элементы.РучкиЯщиков.Доступность = ИзделиеДоступно И НашаДеталь.ЕстьЯщики;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Строка Из Детали Цикл
		...
		Строка.АдресЭлемента = СтруктураАдреса.АдресЭлемента;
		Строка.АдресКрыши = СтруктураАдреса.АдресКрыши;
		...
		Строка.ЕстьЯщики = НашеИзделие.СписокЯщики.Количество() > 0;
		Строка.ЕстьДВП = ЗначениеЗаполнено(НашеИзделие.СписокМатериалы.Найти("ДВП", "Материал"));
		Строка.ЕстьЛДСПДоп = ЗначениеЗаполнено(НашеИзделие.СписокМатериалы.Найти(Истина, "ВторойЦвет"));
