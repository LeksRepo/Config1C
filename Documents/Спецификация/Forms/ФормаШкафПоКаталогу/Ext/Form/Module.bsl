...
Процедура ЗаполнитьСтроку(НашаСтрока, ВидИзделия, Изделие = Неопределено, СтруктураИзделия = Неопределено, ЭлементИзделия = Неопределено)
	...
	Если Изделие = Неопределено Тогда
		...
		Если СтрокаПредопределенных.Количество() = 1 Тогда
			...
			ВидИзделияПоКаталогу = СтрокаПредопределенных[0].ВидИзделияПоКаталогу;
	...
	Для Каждого Строка Из Детали Цикл
		...
		Если Строка.ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ПравыйБоковойЭлемент") Тогда
			...
			Если ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.БоковаяПанельСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.БоковаяПанельСлева");
			ИначеЕсли ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.БоковаяПанельЧерезОтбойнуюПланкуСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.БоковаяПанельЧерезОтбойнуюПланкуСлева");
			ИначеЕсли ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КоробБоковойСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.КоробБоковойСлева");
			ИначеЕсли ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ОтбойнаяПланкаСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ОтбойнаяПланкаСлева");
			ИначеЕсли ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.СтенаСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.СтенаСлева");
			ИначеЕсли ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ФальшПанельСлева") Тогда
				ВидИзделия = ПредопределенноеЗначение("Справочник.ВидыИзделийПоКаталогу.ФальшПанельСлева");
			КонецЕсли;
