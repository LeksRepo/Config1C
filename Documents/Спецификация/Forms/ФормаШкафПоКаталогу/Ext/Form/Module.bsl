...
&НаСервереБезКонтекста
Функция СтруктураНоменклатураМатериала(Стурктура, Номенклатура) 
	
	Стурктура.Вставить("ДлинаДетали", Номенклатура.ДлинаДетали);
	Стурктура.Вставить("ШиринаДетали ", Номенклатура.ШиринаДетали);
	Стурктура.Вставить("ГлубинаДетали ", Номенклатура.ГлубинаДетали);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ШапкаОсновныхНастроек.Вставить("НоменклатураМатериала", "");
