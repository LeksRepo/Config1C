...
Процедура ПриОткрытии(Отказ)
	...
	Если Детали.Количество() > 1 Тогда
		...
		Если ЗначениеЗаполнено(Детали[1].НоменклатураЛДСП) Тогда
			...
			СтруктураПодставляяемойНоменклатуры = ПолучитьКромкуПоЦвету(Детали[1].НоменклатураЛДСП, Подразделение);
...
Процедура ДеталиНоменклатураЛДСППриИзменении(Элемент)
	...
	СтруктураПодставляяемойНоменклатуры = ПолучитьКромкуПоЦвету(ЛДСП, Подразделение);
...
&НаСервереБезКонтекста
Функция ПолучитьКромкуПоЦвету(ЛДСП, Подразделение)
