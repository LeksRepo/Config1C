...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("СправочникСсылка.Двери") Тогда
		
		Двери = ВыбранноеЗначение;
...
Процедура ПеренестиВДокумент(Команда)
	...
	ТаблицаДетали = ПроверитьИУстановитьРазмерыПередСохранением(ПолучитьРазмерыОсновногоЭлемента());
