...
Процедура ПриОткрытии(Отказ)
	...
	Для Каждого Строка Из СписокИзделий Цикл
		...
		Этаформа[НашРазмер]  = "Размеры: " + Строка.ГлубинаИзделия + ";" + Строка.ШиринаИзделия + ";" + Строка.ВысотаИзделия + ?(ЗначениеЗаполнено(Строка.ВысотаИзделия2),"-"+Строка(Строка.ВысотаИзделия2),"") + ?(ЗначениеЗаполнено(Строка.ВысотаИзделия3),"-"+Строка(Строка.ВысотаИзделия3),"");
