...
Процедура НоменклатураОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ВыбранноеЗначение) Тогда
		...
		Элементы.СменяющаяНоменклатура.СписокВыбора.ЗагрузитьЗначения(ПолучитьСписокНоменклатуры(ВыбранноеЗначение, Подразделение));
...
Функция ПолучитьСписокНоменклатуры(Номенклатура, Подразделение)
