...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ОпределительФлеш = "ЧертежДвери" Тогда
		...
		Если ЗначениеЗаполнено(Параметры.Договор) Тогда
			...
			ТипПечатиДвери = "ПечатьИзДоговора";
...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("ФлэшНеОтветил", 2, Истина); 
	
КонецПроцедуры

&НаКлиенте
Процедура ФлэшНеОтветил()
	Закрыть("Ошибка");	
КонецПроцедуры
...
Процедура ХТМЛПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	Если НЕ ФлэшОтветил Тогда
		 ОтключитьОбработчикОжидания("ФлэшНеОтветил");
	КонецЕсли;
	...
	Если ОпределительФлеш = "ЧертежДвери" Тогда
		...
		ИначеЕсли Команда = "prtx" Тогда
			...
			Если ТипПечатиДвери = "ПечатьИзДоговора" Тогда
				Примечание = СтрокиСообщений.ПримечаниеДвери();
			Иначе
