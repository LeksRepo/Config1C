...
Процедура ХТМЛПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	...
	ИначеЕсли ОпределительФлеш = "ЧертежДвери" Тогда
		...
		Если Команда = "init" Тогда
			...
			ТолькоПросмотр = "0";
			ЭлементДляВвода.tag = "ppic☻"+СтрокаДляФлэш+"☻"+ТолькоПросмотр+"☻"+ЛексКлиент.ПолучитьЛоготип(СтруктураМассивовДверей.Спецификация);
			ЭлементДляВвода.click();
			
		ИначеЕсли Команда = "prtx" Тогда
			
			Если ТипПечатиДвери = 0 Тогда
	...
	// RonEXI edit: Этот участок можно будет удалить. Флэшка не может создавать картинки для нескольких дверей.
	//
	...
	//			ЭлементДляВвода.tag = "ppic☻"+СтрокаДляФлэш+"☻"+ЛексКлиент.ПолучитьЛоготип(Спецификация);
	//			ЭлементДляВвода.click();
	//
	//		Иначе
	//			
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	//RonEXI edit: Убрал блокировку закрытия окна, иначе при зависании не закрыть.
