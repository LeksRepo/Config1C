...
Процедура УстановитьПараметр(Таблица, Параметр, ТипПараметра)
	...
	ОбщийФасад = Элементы.Детали.ТекущиеДанные.ВидДеталиФасад;
...
Процедура УстановитьОтборТиповДеталейДляФасада()
	...
	Элементы.ДеталиТаблицаФасадовВидФасада.СписокВыбора.ЗагрузитьЗначения(ВидыФасадов);
...
Процедура ИзделиеПриИзменении(Элемент)
	...
	//очистить фасады принадлежание текущий строке
	Если ЗначениеЗаполнено(ТекущиеДанные.UID) Тогда
		
		СтрокиФасады = ТаблицаФасадов.НайтиСтроки(Новый Структура("sUID", ТекущиеДанные.UID));
		
		Для каждого Строка Из СтрокиФасады Цикл
	...
	Если ЗначениеЗаполнено(СтруктураИзделия) Тогда
		...
		ДанныеИзделия.ЕстьСтолешница = СтруктураИзделия.ЕстьСтолешница;
...
Процедура НастройкиИзделия(ДанныеИзделия)
	...
	Если ДанныеИзделия <> Неопределено Тогда
		Если ЗначениеЗаполнено(ДанныеИзделия.Изделие) Тогда
			...
			Элементы.ДеталиРучка.Видимость = НастройкиФасадов;
			Элементы.ДеталиВидФасада.Видимость = НастройкиФасадов;
			Элементы.ДеталиНоменклатураФасада.Видимость = НастройкиФасадов;
			Элементы.ДеталиКромкаФасада.Видимость = НастройкиФасадов;
...
Процедура ДеталиВидФасадаПриИзменении(Элемент)
	...
	УстановитьПараметр(Элементы.Детали.ТекущиеДанные.ТаблицаФасадов, Элементы.Детали.ТекущиеДанные.ВидДеталиФасад, "ВидДеталиФасад");
	...
	Если ТекущиеДанные <> Неопределено Тогда
		Если ТекущиеДанные.ТаблицаФасадов.Количество() > 0 Тогда
			...
			Если ДанныеТаблицаФасадов <> Неопределено Тогда
				...
				Элементы.ДеталиТаблицаФасадовМеханизмЭлемента.ТолькоПросмотр = НЕ ЭтоЯщик;
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовНоменклатураФасадаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	ВидДеталиФасад = Элементы.ДеталиТаблицаФасадов.ТекущиеДанные.ВидДеталиФасад;
	ПолучитьНомГруппыИОткрытьФормуПодбора(ВидДеталиФасад,"Текстура",Элемент);
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовОбрамлениеФасадаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовНоменклатураРучкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовПетлиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовМеханизмФасадаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовНоменклатураЭлементаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовТорцовкаЭлементаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовДемпферНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
