...
&НаКлиенте
Процедура ДеталиТаблицаФасадовМеханизмЭлементаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДеталиТаблицаФасадовВыдвижнойЭлементНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
