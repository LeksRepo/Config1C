...
Процедура НастройкиИзделия() 
	Если Элементы.Детали.ТекущиеДанные <> Неопределено Тогда
		Если ЗначениеЗаполнено(Элементы.Детали.ТекущиеДанные.Изделие) Тогда
			...
			ЕстьЛДСП = СтруктураИзделия.ЛДСП10 ИЛИ СтруктураИзделия.ЛДСП16 ИЛИ СтруктураИзделия.ЛДСП1010 
			ИЛИ СтруктураИзделия.ЛДСП1610 ИЛИ СтруктураИзделия.ЛДСП1616 ИЛИ СтруктураИзделия.ЯщикиКоличество > 0;
