...
Функция ПроверитьПередСохранением()
	...
	Если Детали.Количество() > 0 Тогда
		...
		Если ЗначениеЗаполнено(КухоннаяКоллекция) Тогда
			...
			ПроверятьУгловые = ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.Угловая
						   ИЛИ ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.ПОбразная;
			...
			Если ПроверятьУгловые Тогда
				...
				Если ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.Угловая И КоличествоУгловых <> 1 Тогда
				...
				ИначеЕсли ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.ПОбразная И КоличествоУгловых <> 2 Тогда
			...
			Если УгловыхДостаточно Тогда
				...
				Для Каждого Элемент Из Детали Цикл
					...
					Если Элемент.Изделие.ВидИзделияПоКаталогу = Справочники.ВидыИзделийПоКаталогу.КухняНижний Тогда
						...
						Если ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.Прямая Тогда
							
							СуммаЦентр = СуммаЦентр + Элемент.ШиринаИзделия; 
							
						КонецЕсли;
						
						Если ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.Угловая Тогда
						...
						Если ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.ПОбразная Тогда
				...
				ИначеЕсли ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.Угловая Тогда
				...
				ИначеЕсли ДанныеКоллекции.Форма = Перечисления.ФормыКухонь.ПОбразная Тогда
