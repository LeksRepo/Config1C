...
Процедура ЗагрузитьЗначениеВыбораФасада() 
	...
	Если ДанныеТаблицаФасадов <> Неопределено Тогда
		...
		Если ДанныеТаблицаФасадов.ВидФасада = "ФасадАГТ" Тогда
			Элементы.ДеталиТаблицаФасадовНоменклатураФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.ФасадыАГТ);
			Элементы.ДеталиТаблицаФасадовОбрамлениеФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.АГТПрофиль);
		ИначеЕсли ДанныеТаблицаФасадов.ВидФасада = "ФасадСтеклянный" Тогда
			Элементы.ДеталиТаблицаФасадовНоменклатураФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.Стекло_И_Зеркало);
		ИначеЕсли ДанныеТаблицаФасадов.ВидФасада = "ФасадЛДСП" Тогда
			Элементы.ДеталиТаблицаФасадовНоменклатураФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.ЛДСП16);
			Элементы.ДеталиТаблицаФасадовОбрамлениеФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.КромкаКФасадам);
		ИначеЕсли ДанныеТаблицаФасадов.ВидФасада = "ФасадМДФ" Тогда
			Элементы.ДеталиТаблицаФасадовНоменклатураФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.МДФ18);
			Элементы.ДеталиТаблицаФасадовОбрамлениеФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.КромкаМДФ);
		ИначеЕсли ДанныеТаблицаФасадов.ВидФасада = "ФасадАлюминиевый" Тогда
			Элементы.ДеталиТаблицаФасадовНоменклатураФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.Стекло_И_Зеркало);
			Элементы.ДеталиТаблицаФасадовОбрамлениеФасада.СписокВыбора.ЗагрузитьЗначения(МассивыНоменклатурныхГрупп.РамочныйАлюминий);
