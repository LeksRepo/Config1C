...
Процедура УстановитьПараметр(Таблица, Параметр, ТипПараметра)
	...
	Для Каждого Строка Из Таблица Цикл
		...
		Если Строка.ВидЭлемента = "Фасад" И 
			...
			ИЛИ (НЕ ЗначениеЗаполнено(Строка.РасположениеПазовИРучкиНаФасадах) И ТипПараметра = "НоменклатураРучки"))) Тогда    
	...
	Для каждого Элемент Из Детали Цикл
		...
		Иначе
			...
			Для Каждого Строка Из Элемент.ТаблицаФасадов Цикл
				...
				Если НЕ ЗначениеЗаполнено(Ручка) И (Строка.ВидЭлемента = "Ящик") Тогда
