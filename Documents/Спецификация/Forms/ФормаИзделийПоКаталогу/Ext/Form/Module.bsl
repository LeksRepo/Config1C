	...
	Для каждого Элемент Из Детали Цикл
		...
		Иначе
			...
			Для Каждого Строка Из Элемент.ТаблицаФасадов Цикл
				...
				Если НЕ ЗначениеЗаполнено(Ручка) И (Строка.ВидЭлемента = "Ящик") или Строка.РасположениеПазовИРучкиНаФасадах.Бе Тогда
				...
				Если Строка.ВидЭлемента = "Фасад" Тогда
					...
					Если (ЗначениеЗаполнено(Ручка) И НЕ ЗначениеЗаполнено(Строка.РасположениеПазовИРучкиНаФасадах)) ИЛИ 
						(ЗначениеЗаполнено(Ручка) И ЗначениеЗаполнено(Строка.РасположениеПазовИРучкиНаФасадах) И НЕ БезРучки) Тогда
