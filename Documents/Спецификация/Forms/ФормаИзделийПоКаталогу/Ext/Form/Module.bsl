...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НазваниеИзделияСпец = Параметры.НазваниеИзделия;
...
Функция УстановитьПараметрыВыбораИзделия()
	...
	ДоступныеВидыИзделий = Новый ФиксированныйМассив(ПолучитьДоступныеВидыИзделий(НазваниеИзделияСпец));
...
Процедура ДеталиИзделиеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Пар.Вставить("НазваниеИзделия", НазваниеИзделияСпец);
