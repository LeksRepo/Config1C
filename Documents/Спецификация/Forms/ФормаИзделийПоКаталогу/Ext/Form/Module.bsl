...
Функция ПолучитьСтруктуруИзделия(Изделие, Подразделение, Серийное, Изменение = Ложь) 
...
Процедура ПерезаполнитьСтруктуруИзделийКаталога(Детали)
	...
	Если ЗначениеЗаполнено(Детали) Тогда
		...
		Для каждого Элемент Из Детали Цикл
			...
			Структура = ПолучитьСтруктуруИзделия(Элемент.Изделие, Подразделение, Серийное);
	...
	Для каждого Элемент Из Детали Цикл
		...
		Иначе
			...
			Для Каждого Строка Из СтрокиФасадов Цикл
				...
				Если НЕ БезФасада И НЕ ЗначениеЗаполнено(Ручка) И Строка.ЕстьРучка И НЕ БезРучки Тогда
			...
			//RonEXI: Костя сказал можно не выбирать.
...
Процедура ИзделиеПриИзменении(Элемент)
	...
	СтруктураИзделия = ПолучитьСтруктуруИзделия(ТекущиеДанные.Изделие, Подразделение, Серийное, Истина);
...
Процедура ТаблицаФасадовПриАктивизацииСтроки(Элемент = Неопределено)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		Если ДанныеТаблицаФасадов <> Неопределено Тогда
			...
			Элементы.ТаблицаФасадовНоменклатураРучки.Доступность = (НЕ ДанныеТаблицаФасадов.БезФасада И НЕ ДанныеТаблицаФасадов.БезРучки);	
