...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если РазностьВДнях < (3 + ЕстьВоскресенье) Тогда
	...
	Отказ = Отказ ИЛИ ПроверитьДоступностьПодразделениямНаСервере(ТекущийОбъект.Комплектация.Выгрузить(, "Номенклатура"), ТекущийОбъект.Подразделение); 
