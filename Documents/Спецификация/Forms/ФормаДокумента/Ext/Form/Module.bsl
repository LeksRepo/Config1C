...
&НаСервере
Функция ПрименитьНаценкуДилера(фнОбъект)
	
	Если НЕ фнОбъект.Дилерский Тогда
		Возврат Истина;
	КонецЕсли;
	...
	Запрос.УстановитьПараметр("НаценкаДилера", НаценкаДилера);
	...
	|	втНоменклатура.Количество,
	|	втНоменклатура.КоличествоТребуется,
	|	втНоменклатура.Цена * &НаценкаДилера КАК Цена,
	|	втНоменклатура.ЗарплатаЦеха,
	|	втНоменклатура.НомерИзделия,
	|	втНоменклатура.НомерСтроки,
	|	втНоменклатура.ИспользуетсяВКоробе,
	...
	|	втНоменклатура.ЧерезСклад,
	|	втНоменклатура.ПредоставитЗаказчик,
	|	втНоменклатура.Цена * &НаценкаДилера * втНоменклатура.Количество КАК РозничнаяСтоимость,
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если НЕ Отказ Тогда
		...
		ПрименитьНаценкуДилера(ТекущийОбъект);
