...
Функция ИзделиеПриИзмененииНаСервере(нИзделие, нКонтрагент)
	...
	Структура.Вставить("ПоказатьТелефон", (нИзделие = Справочники.Изделия.Переделка И нКонтрагент = Справочники.Контрагенты.ЧастноеЛицо));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗапретРедактирования = Объект.Изделие.ЗапретРедактирования;
	...
	СтруктураПараметров.Вставить("ЗапретРедактирования", ЗапретРедактирования);
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		Если Модифицированность
			...
			И НЕ ТекущийОбъект.Издели.ЗапретРедактирования Тогда
