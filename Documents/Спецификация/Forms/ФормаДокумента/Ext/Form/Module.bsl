...
Процедура МонтажникНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ВыбранныйМонтажник = ОткрытьФормуМодально("Документ.Спецификация.Форма.ФормаВыбораМонтажника", ПараметрыФормы);
	Если ЗначениеЗаполнено(ВыбранныйМонтажник) Тогда
		Объект.Монтажник = ВыбранныйМонтажник.Монтажник;
		Объект.ДатаМонтажа = ВыбранныйМонтажник.ДатаМонтажа;
		УстановитьДатуОтгрузки();
	КонецЕсли;
