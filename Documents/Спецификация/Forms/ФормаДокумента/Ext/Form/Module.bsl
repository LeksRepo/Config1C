...
Функция ЗаполнитьУслуги(ТекущийОбъект)
	...
	Если Объект.Упаковка Тогда
		...
		Если Объект.СписокДверей.Количество() > 0 Тогда
			...
			КоличествоДверей = ПосчитатьДвери();
		...
		Если КоличествоДверей > 0 Тогда
			...
			ДобавитьСтроку(ТекущийОбъект, Номенклатура.УпаковкаДверей, ?(КоличествоДверей = Цел(КоличествоДверей), КоличествоДверей/2, Окр(КоличествоДверей/2+0.5)), 0);
