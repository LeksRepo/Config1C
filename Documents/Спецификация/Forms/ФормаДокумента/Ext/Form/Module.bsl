...
Функция ЗаполнитьУслуги(ТекущийОбъект)
	...
	Если Объект.НеноменклатурныйМатериал.Количество() Тогда
...
// { Васильев Александр Леонидович [13.11.2013]
	//Это зачем?
// } Васильев Александр Леонидович [13.11.2013]
...
&НаКлиенте
Процедура ОчиститьНеноменклатурный(Команда)
