...
#КОНЕЦОБЛАСТИ
	...
	// определять по флагу в справочнике изделий
	// } Васильев Александр Леонидович [10.10.2013]
	
	Если НЕ ДилерскийЗаказ И НЕ Объект.Изделие = Справочники.Изделия.Детали И НЕ Объект.Изделие = Справочники.Изделия.Переделка И НЕ Объект.Изделие = Справочники.Изделия.ДопСоглашение Тогда
