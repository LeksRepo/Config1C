...
Функция Собрать()
	...
	ИначеЕсли ИмяТекущейСтраницы = "СтраницаЯщики" Тогда
		...
		ТолькоПросмотрФормы = ТолькоПросмотр ИЛИ Элементы.СтраницаЯщики.ТолькоПросмотр;
	...
	ИначеЕсли ИмяТекущейСтраницы = "СтраницаИзделияПоКаталогу" Тогда
		...
		ТолькоПросмотрФормы = ТолькоПросмотр;
...
Функция ОбновитьДоступностьКоманд()
	...
	КомандыИзменитьСтатус = КоманднаяПанель.ПодчиненныеЭлементы.Статусы.ПодчиненныеЭлементы;
	...
	ТолькоПросмотр = НЕ РазрешитьРедактирование;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		Если Модифицированность И ТекущийСтатус = Перечисления.СтатусыСпецификации.Проверен И ТекущийОбъект.Изделие <> Справочники.Изделия.ШкафКупеПоКаталогу Тогда
