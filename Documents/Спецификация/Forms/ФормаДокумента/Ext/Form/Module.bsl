...
Функция ОбновитьЭлементыФормы(фнФорма, лПараметры)
	...
	Элементы.ФормаУстановитьБезОкругленияДоЛистов.Доступность = НЕ фнФорма.ТолькоПросмотр;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	//Если Объект.ДнейНаИзготовлениеПоНоменклатуре > 2 Тогда
	//	
	//	Стр = ПолучитьКоличествоДнейНаИзготовление(Объект.Ссылка);
	//	
	//	Режим = РежимДиалогаВопрос.ОК;
	//	Текст = "Время изготовления по номенклатуре: " + Стр.Номенклатура + Символы.ПС + "составляет: " + Стр.ДнейНаИзготовление + " дней.";
