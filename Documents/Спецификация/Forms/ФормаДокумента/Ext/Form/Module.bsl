...
Процедура ОбработкаИзделийПоКаталогу()
	...
	Если ИзделиеШкафКупе И НЕ КорпусныйШкафКупе Тогда
		...
		Пол = 0;
		ЗавалПол = Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.Пол,"ВидИзделия").Завал);
		ЗавалЛевый = Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ЛевыйБоковойЭлемент,"ВидИзделия").Завал);
		ЗавалПравый = Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ПравыйБоковойЭлемент,"ВидИзделия").Завал);
		ЗавалПотолок = Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.Потолок,"ВидИзделия").Завал);
		ЗавалСтенка = Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ЗадняяСтенка,"ВидИзделия").Завал);
