...
Процедура ЗаполнитьСтоимость(ТекущийОбъект)
	...
	ТаблицаСпискаМатериаловЗаказчика = ТекущийОбъект.СписокМатериаловЗаказчика.Выгрузить();
	...
	Запрос.УстановитьПараметр("ТаблицаСпискаМатериаловЗаказчика", ТаблицаСпискаМатериаловЗаказчика);
