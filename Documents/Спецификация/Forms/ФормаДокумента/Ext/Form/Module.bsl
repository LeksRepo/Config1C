...
Процедура ОбработкаИзделийПоКаталогу()
	...
	Если ИзделиеШкафКупе Тогда 
		...
		ВысотаПол = СтрокаПол.ВысотаИзделия;
		ШиринаЛевый = СтрокаЛевыйЭлемент.ШиринаИзделия;
		ШиринаПравый = СтрокаПравыйЭлемент.ШиринаИзделия;
		ВысотаПотолок = СтрокаПотолок.ВысотаИзделия;                        
