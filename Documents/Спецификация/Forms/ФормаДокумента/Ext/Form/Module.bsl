...
Функция ЗаполнитьУслуги(ТекущийОбъект)
	...
	Если Объект.ПакетУслуг <> Перечисления.ПакетыУслуг.СамовывозОтПроизводителя Тогда//Объект.Доставка Тогда
		...
		Если Объект.Километраж > 0 или РастояниеДоЗавода > 0 Тогда
			...
			Если Объект.Километраж > 0 и Объект.ПакетУслуг = Перечисления.ПакетыУслуг.ДоставкаДоКлиентаИМонтаж Тогда//Объект.УслугаМонтаж Тогда
