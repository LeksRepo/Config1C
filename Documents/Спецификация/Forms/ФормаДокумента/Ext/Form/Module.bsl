...
Процедура ЗаполнитьСтоимость(ТекущийОбъект)
	...
	Если ТекущийОбъект.Срочный Тогда
		...
		НоваяСтрока.РозничнаяСтоимость = Структура.РозничнаяСтоимость + 1000;
...
Процедура ОбработкаИзделийПоКаталогу()
	...
	Если ИзделиеШкафКупе Тогда 
		...
		Если НЕ КорпусныйШкафКупе Тогда
			...
			СтруктураЗавалов.Вставить("ЗавалПол", Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.Пол,"ВидИзделия").Завал));
			СтруктураЗавалов.Вставить("ЗавалЛевый", Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ЛевыйБоковойЭлемент,"ВидИзделия").Завал));
			СтруктураЗавалов.Вставить("ЗавалПравый", Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ПравыйБоковойЭлемент,"ВидИзделия").Завал));
			СтруктураЗавалов.Вставить("ЗавалПотолок", Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.Потолок,"ВидИзделия").Завал));
			СтруктураЗавалов.Вставить("ЗавалСтенка", Число(ТаблицаИзделийПоКаталогу.Найти(Справочники.ВидыИзделийПоКаталогу.ЗадняяСтенка,"ВидИзделия").Завал));
...
Процедура Подбор(Команда)
	...
	ОткрытьФорму("Документ.Спецификация.Форма.ФормаПодборКомплектации",Пар,Элементы.Комплектация);
КонецПроцедуры
