...
Процедура ЗаполнитьСтоимость(ТекущийОбъект)
	...
	Запрос.УстановитьПараметр("СкидкаНаУслуги", 0);
	Запрос.УстановитьПараметр("СкидкаНаМатериал", 0);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	ПересчитатьСуммуСоСкидкой(); // это зачем после записи?
...
Процедура СписокМатериалыОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") Тогда
		...
		КонецЕсли;
		Если ВыбранноеЗначение.Свойство("ТаблицаДеталей") Тогда
			ЗагрузитьТабличнуюЧасть(ВыбранноеЗначение.ТаблицаДеталей, Элемент.Имя);
		КонецЕсли;
		Если ВыбранноеЗначение.Свойство("ТаблицаЯщиков") Тогда
			ЗагрузитьТабличнуюЧасть(ВыбранноеЗначение.ТаблицаЯщиков, "СписокЯщики");
		КонецЕсли;
