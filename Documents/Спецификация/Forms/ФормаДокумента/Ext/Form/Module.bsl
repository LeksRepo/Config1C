...
Функция ЗаполнитьМатериалы(ТекущийОбъект, Ошибки, ПродаваемоеКоличествоМатериала)
	...
	НазваниеИзделия = ТекущийОбъект.НазваниеИзделия;
	...
	Для каждого Строка Из НазваниеИзделия.СписокНоменклатуры Цикл
...
Функция ОткрытьФормуПодбора(ИмяПодбора, ТаблицаДляФормы, СтрокаДанных, ВладелецПодобра, ПараметрыПодбора = Неопределено)
	...
	ПараметрыПодбора.Вставить("НазваниеИзделия", Объект.НазваниеИзделия);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураПараметров.Вставить("Заблокировать", НЕ ЗначениеЗаполнено(Объект.Изделие) ИЛИ НЕ ЗначениеЗаполнено(Объект.НазваниеИзделия));
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если НЕ ЗначениеЗаполнено(Объект.НазваниеИзделия) Тогда
		
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Укажите название изделия",, "НазваниеИзделия", "Объект", Отказ);
...
&НаКлиенте
Процедура НазваниеИзделияПриИзменении(Элемент)
