	...
	Для Каждого Элемент Из Объект.СписокИзделийПоКаталогу Цикл
		...
		Для Каждого Строка Из СписокНоменклатурыИзделия Цикл
			...
			Попытка
				...
				//Если НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.ФурнитураКрепежная и СтруктураПодбираемойПоЦветуНоменклатуры.Свойство("ШкафПоКаталогу") Тогда
				//	
				//	Номенклатура = СтруктураПодбираемойПоЦветуНоменклатуры.ШкафПоКаталогу.ФурнитураКрепежная;
				//	
				//ИначеЕсли НоменклатурнаяГруппа = Справочники.НоменклатурныеГруппы.ФурнитураКрепежная и СтруктураПодбираемойПоЦветуНоменклатуры.Свойство("ШкафПоКаталогу") Тогда
				//	
