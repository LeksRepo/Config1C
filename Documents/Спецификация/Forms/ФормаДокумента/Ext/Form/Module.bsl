...
Функция ЗаполнитьМатериалы(ТекущийОбъект)
	...
	//ТекущийОбъект.НеноменклатурныйМатериал.Очистить();
	...
	Для каждого Строка Из ТекущийОбъект.Комплектация Цикл
		...
		ДобавитьСтроку(ТекущийОбъект, Строка.Номенклатура, Строка.Количество, Строка.НомерИзделия, ЕстьНеноменклатурный);
	...
	//			ДобавитьСтроку(ТекущийОбъект, Элемент.НоменклатураДопЭлемента, 1, Строка.НомерСтроки, ЕстьНеноменклатурный);
	//		КонецЦикла;
	//	КонецЕсли;
	//	
	//КонецЦикла;
	...
	ТекущийОбъект.НеноменклатурныйМатериал.Свернуть("Номенклатура, ЕдиницаИзмерения, Комментарий", "Количество, Цена");
	...
	//	НоваяСтрока.ЕдиницаИзмерения 	= НоваяСтрока.Номенклатура.ЕдиницаИзмерения;
	//	НоваяСтрока.Количество 				= Строка.Количество;
	//	НоваяСтрока.РозничнаяСтоимость = Строка.Цена;
	//				
	//КонецЦикла;
