...
Процедура ПересчитатьСуммуСоСкидкой()
	...
	СтруктураСкидка = ЛексСервер.ПолучитьСкидкуДоговора(Объект.Подразделение, Объект.Дата, Объект.СуммаДокумента, ВидОплаты, Объект.Офис, Объект.Контрагент, Объект.Ссылка);
