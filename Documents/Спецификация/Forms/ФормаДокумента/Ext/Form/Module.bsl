...
Функция ЗаполнитьХлыстовойМатериал(фнОбъект)
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		Пока МассивОтрезков.Количество() > 0 Цикл
			...
			Если РезультатРаскроя.Сумма % Кратность > 0 Тогда
				ЦелыхХлыстов = Цел(РезультатРаскроя.Сумма / Кратность); // Кратных отрезков
				ПродатьХлыстов = (ЦелыхХлыстов + 1) * Кратность;
