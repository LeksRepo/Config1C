...
#КОНЕЦОБЛАСТИ
	...
	Если НЕ ДилерскийЗаказ И НЕ Объект.Изделие = Справочники.Изделия.Детали И НЕ Объект.Изделие = Справочники.Изделия.Переделка И Объект.Изделие = Справочники.Изделия.ДопСоглашение Тогда
