	...
	Если ЗначениеЗаполнено(Объект.КухоннаяКоллекция) И Объект.НастройкиКоллекции.Количество() > 0 Тогда
		...
		Если ЗначениеЗаполнено(Данные.Форма) Тогда
			...
			Если КоличествоСторон = 1 Тогда
				...
				Если ЗначениеЗаполнено(Данные.ШиринаКухниЦентр) Тогда
					 Заполнено = Истина;	
				КонецЕсли;
				  
			ИначеЕсли КоличествоСторон = 2 Тогда
				
				Если ЗначениеЗаполнено(Данные.ШиринаКухниЛево) И ЗначениеЗаполнено(Данные.ШиринаКухниЦентр) Тогда
					 Заполнено = Истина;	
				КонецЕсли;
				
			ИначеЕсли КоличествоСторон = 3 Тогда
			 
				Если ЗначениеЗаполнено(Данные.ШиринаКухниЛево) И ЗначениеЗаполнено(Данные.ШиринаКухниЦентр) И ЗначениеЗаполнено(Данные.ШиринаКухниПраво) Тогда
					 Заполнено = Истина;	
				КонецЕсли;
