...
Процедура ОбновитьВидимостьНастройкиКоллекции()
	...
	Если Объект.НастройкиКоллекции.Количество() > 0 Тогда
		...
		Если ЗначениеЗаполнено(ТекДанные.Форма) Тогда
			 ...
			 Элементы.ДекорацияКартинкаФормаКухни1.Видимость = Ложь;
			 Элементы.ДекорацияКартинкаФормаКухни2.Видимость = Ложь;
			 Элементы.ДекорацияКартинкаФормаКухни3.Видимость = Ложь;
			 ...
			 Если ТекДанные.Форма = ПредопределенноеЗначение("Перечисление.ФормыКухонь.Прямая") Тогда
			 	Элементы.ДекорацияКартинкаФормаКухни1.Видимость = Истина; 
			 ИначеЕсли ТекДанные.Форма = ПредопределенноеЗначение("Перечисление.ФормыКухонь.Угловая") Тогда
				Элементы.ДекорацияКартинкаФормаКухни2.Видимость = Истина;
			 ИначеЕсли ТекДанные.Форма = ПредопределенноеЗначение("Перечисление.ФормыКухонь.ПОбразная") Тогда
				Элементы.ДекорацияКартинкаФормаКухни3.Видимость = Истина;
			 КонецЕсли;
