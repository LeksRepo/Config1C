...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ФурнитураКрепежная 			= Новый СписокЗначений;
	
	ФурнитураКрепежная.Добавить(Справочники.НоменклатурныеГруппы.ФурнитураКрепежная);
		
	МассивКрепежа = ЛексСервер.ОтборНоменклатурныхГрупп(ФурнитураКрепежная, Подразделение);
	
	Если МассивКрепежа.Свойство("ФурнитураКрепежная") Тогда
		
		Элементы.Уголки.СписокВыбора.ЗагрузитьЗначения(МассивКрепежа.ФурнитураКрепежная);
...
Процедура Рассчитать(Команда)
	...
	УголкиКоличество 		= ДанныеОКоличествах.КоличествоДеталейЛДСП * 4;
...
Процедура Сохранить(Команда)
	...
	Если ЗначениеЗаполнено(Уголки) и УголкиКоличество = 0 Тогда
		...
		Сообщение.Текст 	= "Не выбрано количество уголков";
	...
	Если УголкиКоличество > 0 и НЕ ЗначениеЗаполнено(Уголки) Тогда
		...
		Сообщение 			= Новый СообщениеПользователю;
		Сообщение.Текст 	= "Не выбраны уголки";
