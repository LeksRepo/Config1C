	...
	Если НЕ Запрос.Выполнить().Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Выборка.СуммаОстаток > 0 Тогда
				...
				СрокАмортизации = ?(Выборка.СрокАмортизации = 0, 1, Выборка.СрокАмортизации);  
								
				Если СрокАмортизации > 0 Тогда
					
					СуммаАмортизации = Мин(Выборка.СуммаПС / СрокАмортизации, Выборка.СуммаОстаток);
				...
				Иначе
					...
					Отказ = Истина;
					Сообщить("Не установлен срок амортизации для: " + Выборка.ОсновноеСредство);
