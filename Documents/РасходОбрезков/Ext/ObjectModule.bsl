...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	ПроведениеУдержаний(Отказ);
	
КонецПроцедуры

Процедура ПроведениеУдержаний(Отказ)
	...
	Если НЕ Отказ Тогда
		...
		Если СписокВиновных.Количество() > 0 Тогда
			...
			Для Каждого Стр ИЗ СписокВиновных Цикл
					...
					Проводка.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.ВидыНачисленийУдержаний] = Справочники.ВидыНачисленийУдержаний.УдержанияЗаСписаниеОбрезков;
