...
Процедура Подобрать(Команда)
	...
	ПараметрыФомы.Вставить("МассивМатериалов", ЗаполнитьВидыМатериалов());
...
&НаКлиенте
Функция ЗаполнитьВидыМатериалов()

	    МассивМатериалов = Новый Массив;
		МассивМатериалов.Добавить("Листовой");
		
		Возврат МассивМатериалов;

КонецФункции // ЗаполнитьВидыМатериалов()
