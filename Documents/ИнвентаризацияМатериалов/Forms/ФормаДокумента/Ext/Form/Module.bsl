...
Процедура ЗаполнитьСписокНоменклатурыОстатками()
	...
	|					И УправленческийОстатки.Субконто2.Базовый
...
Функция ПерезаполнитьУчетныеДанныеСервер()
	...
	|	тзСписокНоменклатуры.КоличествоУчетное,
	...
	|	ЕСТЬNULL(УправленческийОстатки.КоличествоОстатокДт, 0) КАК КоличествоУчетное,
	|	втСписокНоменклатуры.КоличествоФакт КАК КоличествоФакт,
	|	ЕСТЬNULL(УправленческийОстатки.СуммаОстатокДт, 0) КАК СтоимостьУчетная,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(УправленческийОстатки.КоличествоОстатокДт, 0) <> 0
	|			ТОГДА УправленческийОстатки.СуммаОстатокДт / ЕСТЬNULL(УправленческийОстатки.КоличествоОстатокДт, 0) * втСписокНоменклатуры.КоличествоФакт
	...
	|				КОНЕЦ, 0) * втСписокНоменклатуры.КоличествоФакт
	...
	|				КОНЕЦ, 0)
	|	КОНЕЦ КАК Цена,
	|	втСписокНоменклатуры.КоличествоФакт - ЕСТЬNULL(УправленческийОстатки.КоличествоОстатокДт, 0) КАК Отклонение
	|ИЗ
