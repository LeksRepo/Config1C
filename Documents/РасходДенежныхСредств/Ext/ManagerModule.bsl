...
Функция ПечатьКассовыйОрдер(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для каждого Объект Из МассивОбъектов Цикл
		...
		МассивРеквизитов = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(Объект, "Подразделение, Субконто2Дт");
		Запрос = Новый Запрос;
		...
		Пока Выборка.Следующий() Цикл
			...
			НужноПечататьДопТаблицу = Истина;
			...
			//ТабДок.ВывестиГоризонтальныйРазделительСтраниц();
				...
				Запрос.УстановитьПараметр("Сотрудник", МассивРеквизитов.Субконто2Дт);
				...
				Пока ВыборкаПоГруппам.Следующий() Цикл
					...
					Пока ДетальнаяВыборка.Следующий() Цикл
						...
						Если ДетальнаяВыборка.Подразделение = МассивРеквизитов.Подразделение Тогда
