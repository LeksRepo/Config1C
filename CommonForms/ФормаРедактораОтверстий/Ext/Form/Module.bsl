...
Процедура УстановитьДоступность() 
	...
	Если ЗначениеЗаполнено(ВидОтверстий) Тогда
		...
		Элементы.Смещение.Доступность = Ложь;//ДоступноСмещениеОтступ;
...
Процедура ВидЕвропазПриИзменении(Элемент)
	...
	УстановитьНастройкиПолей(Истина);
...
&НаКлиенте
Процедура УстановитьНастройкиПолей(Значение = Ложь)
	
	Элементы.КоличествоОтверстийСверху.РедактированиеТекста = НЕ Значение;
	Элементы.КоличествоОтверстийСверху.КнопкаСпискаВыбора = Значение;
	Элементы.КоличествоОтверстийСнизу.РедактированиеТекста = НЕ Значение;
	Элементы.КоличествоОтверстийСнизу.КнопкаСпискаВыбора = Значение;
	Элементы.КоличествоОтверстийСлева.РедактированиеТекста = НЕ Значение;
	Элементы.КоличествоОтверстийСлева.КнопкаСпискаВыбора = Значение;
	Элементы.КоличествоОтверстийСправа.РедактированиеТекста = НЕ Значение;
	Элементы.КоличествоОтверстийСправа.КнопкаСпискаВыбора = Значение;
	
КонецПроцедуры // УстановитьНастройкиПолей()
