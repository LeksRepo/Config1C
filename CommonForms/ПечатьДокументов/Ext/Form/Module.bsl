...
Процедура Печать(Команда)
	...
	Если ПользователиКлиентСервер.ЭтоСеансВнешнегоПользователя() Тогда	
		ЛексСервер.ЗаписатьДействиеПользователя(Неопределено, ПредопределенноеЗначение("Перечисление.ВидыАктивностиПользователей.ПечатьКомплектДокументов"));
	КонецЕсли;
...
Процедура ЗагрузитьНастройкиКоличестваКопий()
	...
	//RonEXI исправил на Ложь чтобы не глючило количество.
	ИспользоватьСохраненныеНастройки = Ложь;
