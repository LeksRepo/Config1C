...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.СтарыйАдрес) Тогда
		...
		СтруктураАдреса.Вставить("СписокУлиц", ЗапроситьСписокУлиц(СтруктураДляУлиц));
...
Функция  СформироватьАдрес()
	...
	Адрес = "";
	Адрес = Адрес + НаселенныйПункт + "," + " ул. " + Улица + "," + " дом. " + Дом + "," + ?(ЗначениеЗаполнено(Подъезд), " подъезд. " + Подъезд + ",", "") + 
...
Процедура ОбработкаВыбораНП(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТипЗнч(СтруктураНаселенногоПункта) = Тип("Структура") Тогда
		...
		Элементы.Улица.СписокВыбора.ЗагрузитьЗначения(СтруктураНаселенногоПункта.СписокУлиц);
