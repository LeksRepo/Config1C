...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.СтарыйАдрес) Тогда
		...
		Если Параметры.Свойство("Километраж") Тогда
	...
	Если Параметры.Свойство("ГородВладелец") Тогда
		ГородВладелец = Параметры.ГородВладелец;
	ИначеЕсли Параметры.Свойство("Офис") Тогда
