...
Процедура ЭППодписать(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЭППодписатьПодписьСформирована", ЭтотОбъект, ТекущиеДанные);
	ПрисоединенныеФайлыСлужебныйКлиент.СформироватьПодписьФайла(ОписаниеОповещения, ТекущиеДанные.Ссылка, ДанныеФайла);
	
КонецПроцедуры

&НаКлиенте
Процедура ЭППодписатьПодписьСформирована(ПодписьСформирована, ТекущиеДанные) Экспорт
