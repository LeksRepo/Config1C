...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Режим = "Коллекция" Тогда 
	
		Формулы.Параметры.УстановитьЗначениеПараметра("ТипФормулы", "КухонныеКоллекции");	
		
	ИначеЕсли Режим = "ВидДетали" ИЛИ Режим = "ВидОплаты" ИЛИ Режим = "Присадки" Тогда 
...
Процедура ЗаполнитьДоступныеПеременные()
	...
	Если Режим = "Коллекция" Тогда
		
		ДоступныеПеременные.Добавить("КоробаНизЛево[0].");
		ДоступныеПеременные.Добавить("КоробаНизЦентр[0].");
		ДоступныеПеременные.Добавить("КоробаНизПраво[0].");
		ДоступныеПеременные.Добавить("КоличествоНизЛево");
		ДоступныеПеременные.Добавить("КоличествоНизЦентр");
		ДоступныеПеременные.Добавить("КоличествоНизПраво");
		ДоступныеПеременные.Добавить("Левый");
		ДоступныеПеременные.Добавить("Правый");
		ДоступныеПеременные.Добавить("ГлубинаКухниЛево");
		ДоступныеПеременные.Добавить("ГлубинаКухниЦентр");
		ДоступныеПеременные.Добавить("ГлубинаКухниПраво");
		ДоступныеПеременные.Добавить("ШиринаКухниЛево");
		ДоступныеПеременные.Добавить("ШиринаКухниЦентр");
		ДоступныеПеременные.Добавить("ШиринаКухниПраво");
		
	КонецЕсли;
	
	Если Режим = "Присадки" Тогда
			...
			ДоступныеПеременные.Добавить("ВысотаИзделияВерх");
			ДоступныеПеременные.Добавить("ВысотаИзделияНиз");
	...
	Если Режим = "Каталог" Тогда
			...
			ДоступныеПеременные.Добавить("ШиринаДоп");
			ДоступныеПеременные.Добавить("ГлубинаДоп");
			ДоступныеПеременные.Добавить("РасположениеСлева");
			ДоступныеПеременные.Добавить("Сборка");
			ДоступныеПеременные.Добавить("КоличествоОтделов");
			ДоступныеПеременные.Добавить("НомерОтдела");
			ДоступныеПеременные.Добавить("ШиринаОтсека1");
			ДоступныеПеременные.Добавить("ШиринаОтсека2");
			ДоступныеПеременные.Добавить("ШиринаОтсека3");
			ДоступныеПеременные.Добавить("ШиринаОтсека4");
			ДоступныеПеременные.Добавить("ВысотаАнтПолки");
	...
	Если Режим = "СхемаЯщика" Тогда
			...
			ДоступныеПеременные.Добавить("КриволинейныйВыпилПодРучку");
			ДоступныеПеременные.Добавить("РучкаЩель");
	...
	Если Режим = "ВидОплаты" Тогда
		
			ДоступныеПеременные.Добавить("СуммаДокументаБезСкидки");
...
Процедура ЗаполнитьПеременные()
	...
	Если Режим = "Коллекция" Тогда
		...
		СтруктураПеременных.Добавить("КоробаНизЛево[0].");
		СтруктураПеременных.Добавить("КоробаНизЦентр[0].");
		СтруктураПеременных.Добавить("КоробаНизПраво[0].");
		СтруктураПеременных.Добавить("КоличествоНизЛево");
		СтруктураПеременных.Добавить("КоличествоНизЦентр");
		СтруктураПеременных.Добавить("КоличествоНизПраво");
		СтруктураПеременных.Добавить("Левый");
		СтруктураПеременных.Добавить("Правый");
		СтруктураПеременных.Добавить("ГлубинаКухниЛево");
		СтруктураПеременных.Добавить("ГлубинаКухниЦентр");
		СтруктураПеременных.Добавить("ГлубинаКухниПраво");
		СтруктураПеременных.Добавить("ШиринаКухниЛево");
		СтруктураПеременных.Добавить("ШиринаКухниЦентр");
		СтруктураПеременных.Добавить("ШиринаКухниПраво");
		СтруктураПеременных.Добавить("Столешница");
		СтруктураПеременных.Добавить("Пристенок");
		
			Эл = Новый Массив;
			Эл.Добавить("ВысотаИзделия");
			Эл.Добавить("ГлубинаИзделия");
			Эл.Добавить("ШиринаИзделия");
			Эл.Добавить("Расположение");
			Эл.Добавить("Изделие");
		
		Раздел = Новый Массив;
		Раздел.Добавить("РеквизитыКороба");
		Раздел.Добавить(Эл);
		
		СтруктураПеременных.Добавить(Раздел);
		
			Эл = Новый Массив;
			Эл.Добавить("ЭтоПенал");
			Эл.Добавить("ЭтоОтступ");
			Эл.Добавить("ЭтоВытяжка");
			Эл.Добавить("ЭтоХолодильник");
			Эл.Добавить("ЭтоХолодильникОтдельностоящий");
			Эл.Добавить("ЭтоКоробПодВытяжку");
			Эл.Добавить("ЭтоПустойКороб");
			Эл.Добавить("ЭтоУгловойКороб45");
			Эл.Добавить("ЭтоПлитаОтдельностоящая");
			Эл.Добавить("АлюмПрофильВерхний");
			Эл.Добавить("АлюмПрофильНижний");
		
		Раздел = Новый Массив;
		Раздел.Добавить("РеквизитыИзделия");
		Раздел.Добавить(Эл);
	...
	Если Режим = "Присадки" Тогда
			...
			СтруктураПеременных.Добавить("ВысотаИзделия");
			СтруктураПеременных.Добавить("ВысотаИзделияВерх");
			СтруктураПеременных.Добавить("ВысотаИзделияНиз");
			СтруктураПеременных.Добавить("ШиринаИзделия");
			СтруктураПеременных.Добавить("ГлубинаИзделия");
	...
	Если Режим = "ВидОплаты" Тогда
			...
			СтруктураПеременных.Добавить("СуммаДокументаБезСкидки");
	...
	Если Режим = "СхемаЯщика" Тогда
			...
			СтруктураПеременных.Добавить("КриволинейныйВыпилПодРучку");
			СтруктураПеременных.Добавить("РучкаЩель");
	...
	Если Режим = "Каталог" Тогда
				...
				Эл.Добавить("ШиринаИзделия");
				Эл.Добавить("ВысотаИзделия");
				Эл.Добавить("ВысотаИзделияВерх");
				Эл.Добавить("ВысотаИзделияНиз");
				Эл.Добавить("ГлубинаИзделия");
				...
				Эл.Добавить("ШиринаДоп");
				Эл.Добавить("ГлубинаДоп");
			...
			СтруктураПеременных.Добавить("РасположениеСлева");
			СтруктураПеременных.Добавить("Сборка");
			
			СтруктураПеременных.Добавить("КоличествоОтделов");
			СтруктураПеременных.Добавить("НомерОтдела");
			
			СтруктураПеременных.Добавить("ШиринаОтсека1");
			СтруктураПеременных.Добавить("ШиринаОтсека2");
			СтруктураПеременных.Добавить("ШиринаОтсека3");
			СтруктураПеременных.Добавить("ШиринаОтсека4");
			СтруктураПеременных.Добавить("ВысотаАнтПолки");
...
&НаКлиенте
Процедура КомандаДобавитьБольше(Команда)
	ДобавитьКФормуле(">");
КонецПроцедуры

&НаКлиенте
Процедура КомандаДобавитьМеньше(Команда)
	ДобавитьКФормуле("<");
КонецПроцедуры
