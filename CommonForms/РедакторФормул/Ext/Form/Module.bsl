...
Процедура ЗаполнитьДоступныеПеременные()
	...
	Если Режим = "Присадки" Тогда
			...
			ДоступныеПеременные.Добавить("ВысотаИзделия2");
			ДоступныеПеременные.Добавить("ВысотаИзделия3");
...
Процедура ЗаполнитьПеременные()
	...
	Если Режим = "Присадки" Тогда
			...
			СтруктураПеременных.Добавить("ВысотаИзделия2");
			СтруктураПеременных.Добавить("ВысотаИзделия3");
	...
	Если Режим = "Каталог" Тогда
				...
				Эл.Добавить("ШиринаИзделия");
				Эл.Добавить("ВысотаИзделия");
				Эл.Добавить("ВысотаИзделия2");
				Эл.Добавить("ВысотаИзделия3");
				Эл.Добавить("ГлубинаИзделия");
