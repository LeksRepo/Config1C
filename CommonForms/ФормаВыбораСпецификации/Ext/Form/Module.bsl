...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.МатериалЗаказчикаНеПредоставлен.Видимость = Ложь;
...
Процедура ЗаполнитьТаблицуСпецификаций(Подразделение, Статус, ПереданнаяТаблица = Неопределено)
	...
	Если ЕстьСпецификацииБезПрихода Тогда
		Элементы.МатериалЗаказчикаНеПредоставлен.Видимость = Истина;
	КонецЕсли;
...
Процедура СортироватьПоВозростанию(Команда)
	СортироватьПоВозростаниюСервер(Элементы.ТЗ.ТекущийЭлемент.Имя);
КонецПроцедуры

&НаСервере
Процедура СортироватьПоВозростаниюСервер(Колонка)
	ТЗ.Сортировать(Колонка + " Возр");	
КонецПроцедуры

&НаКлиенте
Процедура СортироватьПоУбыванию(Команда)
	СортироватьПоУбываниюСервер(Элементы.ТЗ.ТекущийЭлемент.Имя);
КонецПроцедуры

&НаСервере
Процедура СортироватьПоУбываниюСервер(Колонка)
	ТЗ.Сортировать(Колонка + " Убыв");	
КонецПроцедуры
